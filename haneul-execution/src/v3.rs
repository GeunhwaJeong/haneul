...
impl executor::Executor for Executor {
    fn execute_transaction_to_effects(
        ...
        _system_object_versions: haneul_types::base_types::SystemObjectVersions,
        _unsettled_object_funds: &dyn haneul_types::accumulator_root::UnsettledObjectFundsRead,
        gas: GasData,
