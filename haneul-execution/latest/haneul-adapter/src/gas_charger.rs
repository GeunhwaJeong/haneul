...
pub mod checked {
    ...
    impl GasCharger {
        ...
        pub fn new_unmetered(
            ...
            Self {
                ...
                gas_status: HaneulGasStatus::new_unmetered(protocol_config),
            }
        }
        ...
        pub fn round_computation<T, E: ExecutionErrorTrait>(
            ...
            let is_move_abort = matches!(
                ...
                Some(haneul_types::execution_status::ExecutionErrorKind::MoveAbort(..))
            );
        ...
        /// Apply the final gas charge derived from the current `HaneulGasStatus`, per payment kind
        ...
        pub fn charge<T, E: ExecutionErrorTrait>(
            ...
            match &self.payment {
                PaymentMetadata::Unmetered => {
                    // Park unmetered (system-tx) storage rebate into 0x5 so HANEUL is not dropped.
    ...
    /// what `origin/main` produces today, including the HANEULPR-753 surgical fix gated on
