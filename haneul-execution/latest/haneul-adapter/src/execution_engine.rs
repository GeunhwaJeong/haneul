...
pub(crate) mod checked {
    ...
    use haneul_types::gas_model::gas_predicates::bump_only_enabled;
    ...
    use haneul_types::base_types::{ObjectID, SequenceNumber, SystemObjectVersions};
    ...
    pub struct ExecutionOutput<Mode: ExecutionMode> {
        ...
        pub gas_status: HaneulGasStatus,
    ...
    /// Post-execution consistency: HANEUL conservation, the expensive ownership invariants, and (on
    ...
    fn report_bump_only<Mode: ExecutionMode>(
        ...
        debug_fatal_with_metric!(
            |metrics: &haneullabs_metrics::Metrics| {
                metrics
    ...
    fn run_conservation_checks<Mode: ExecutionMode>(
        ...
        if let Err(conservation_err) = temporary_store.check_conservation_invariants::<Mode>(
            ...
            tracing::error!(
                ...
                "HANEUL conservation check failed; falling back to the no-op exit (State 2): \
                 dropping all writes and charging nothing",
            );
