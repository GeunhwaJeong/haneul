...
import (
	...
	bindings "github.com/GeunhwaJeong/haneul/wasmbindings"
	junoburn "github.com/GeunhwaJeong/haneul/x/burn"
	clockkeeper "github.com/GeunhwaJeong/haneul/x/clock/keeper"
	clocktypes "github.com/GeunhwaJeong/haneul/x/clock/types"
	cwhookskeeper "github.com/GeunhwaJeong/haneul/x/cw-hooks/keeper"
	cwhookstypes "github.com/GeunhwaJeong/haneul/x/cw-hooks/types"
	dripkeeper "github.com/GeunhwaJeong/haneul/x/drip/keeper"
	driptypes "github.com/GeunhwaJeong/haneul/x/drip/types"
	feepaykeeper "github.com/GeunhwaJeong/haneul/x/feepay/keeper"
	feepaytypes "github.com/GeunhwaJeong/haneul/x/feepay/types"
	...
	globalfeekeeper "github.com/GeunhwaJeong/haneul/x/globalfee/keeper"
	globalfeetypes "github.com/GeunhwaJeong/haneul/x/globalfee/types"
	mintkeeper "github.com/GeunhwaJeong/haneul/x/mint/keeper"
	minttypes "github.com/GeunhwaJeong/haneul/x/mint/types"
	tokenfactorykeeper "github.com/GeunhwaJeong/haneul/x/tokenfactory/keeper"
	tokenfactorytypes "github.com/GeunhwaJeong/haneul/x/tokenfactory/types"
	// wrappers
	wrappedgovkeeper "github.com/GeunhwaJeong/haneul/x/wrappers/gov/keeper"
)
...
func NewAppKeepers(
	...
	wasmOpts = append(wasmOpts, wasmkeeper.WithGasRegister(NewHaneulWasmGasRegister()))

	wasmer, err := wasmvm.NewVM(wasmDir, wasmCapabilities, 32, wasmConfig.ContractDebugMode, wasmConfig.MemoryCacheSize)
	if err != nil {
		panic(fmt.Sprintf("failed to create haneul wasmvm: %s", err))
	}
