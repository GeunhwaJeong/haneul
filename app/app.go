...
import (
	...
	"github.com/GeunhwaJeong/haneul/app/keepers"
	upgrades "github.com/GeunhwaJeong/haneul/app/upgrades"
	v28 "github.com/GeunhwaJeong/haneul/app/upgrades/v28"
	v29 "github.com/GeunhwaJeong/haneul/app/upgrades/v29"
	"github.com/GeunhwaJeong/haneul/docs"
)
...
var (
	NodeDir = ".haneul"
	// DefaultNodeHome default home directories for Haneul
...
// New returns a reference to an initialized Haneul.
func New(
	logger log.Logger,
	db dbm.DB,
...
// AutoCLIOpts returns options based upon the modules used on Haneul.
...
// AppCodec returns Haneul's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns Haneul's InterfaceRegistry
func (app *App) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// InterfaceRegistry returns Haneul's TxConfig
