...
import (
	...
	"github.com/GeunhwaJeong/haneul/testutil"
	ante "github.com/GeunhwaJeong/haneul/x/feeshare/ante"
	feesharekeeper "github.com/GeunhwaJeong/haneul/x/feeshare/keeper"
	feesharetypes "github.com/GeunhwaJeong/haneul/x/feeshare/types"
)
...
func (s *AnteTestSuite) TestAnteHandle() {
	...
	s.FundModuleAcc(authtypes.FeeCollectorName, sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(1_000_000))))

	// Create & fund deployer
	_, _, deployer := testdata.KeyTestPubAddr()
	s.FundAcc(deployer, sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(100_000_000))))
	...
	executeMsg := &wasmtypes.MsgExecuteContract{
		...
		Msg:      []byte("{}"),
		Funds:    sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(0))),
	}
	...
	receiverBal := s.bankKeeper.GetBalance(s.Ctx, receiver, "uhaneul")
...
func (s *AnteTestSuite) TestFeeLogic() {
	...
	feeCoins := sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(500)), sdk.NewCoin("utoken", sdkmath.NewInt(250)))
	...
	testCases := []struct {
	...
	}{
		{
			...
			1,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(500)), sdk.NewCoin("utoken", sdkmath.NewInt(250))),
		},
		{
			"100% fee / 2 contracts",
			feeCoins,
			sdkmath.LegacyNewDecWithPrec(100, 2),
			2,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(250)), sdk.NewCoin("utoken", sdkmath.NewInt(125))),
		},
		{
			...
			sdkmath.LegacyNewDecWithPrec(100, 2),
			10,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(50)), sdk.NewCoin("utoken", sdkmath.NewInt(25))),
		},
		{
			"67% fee / 7 contracts",
			feeCoins,
			...
			7,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(48)), sdk.NewCoin("utoken", sdkmath.NewInt(24))),
		},
		{
			"50% fee / 1 contracts",
			feeCoins,
		...
		},
		{
			...
			sdkmath.LegacyNewDecWithPrec(50, 2),
			2,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(125)), sdk.NewCoin("utoken", sdkmath.NewInt(62))),
		},
		{
			"50% fee / 3 contracts",
			feeCoins,
			sdkmath.LegacyNewDecWithPrec(50, 2),
			3,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(83)), sdk.NewCoin("utoken", sdkmath.NewInt(42))),
		},
		{
			"25% fee / 2 contracts",
			feeCoins,
			...
			2,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(62)), sdk.NewCoin("utoken", sdkmath.NewInt(31))),
		},
		{
			"15% fee / 3 contracts",
			feeCoins,
			...
			3,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(25)), sdk.NewCoin("utoken", sdkmath.NewInt(12))),
		},
		{
			"1% fee / 2 contracts",
			feeCoins,
			...
			2,
			sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(2)), sdk.NewCoin("utoken", sdkmath.NewInt(1))),
		},
	}
...
func (MockTx) GetFee() sdk.Coins {
	return sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(500)))
}
