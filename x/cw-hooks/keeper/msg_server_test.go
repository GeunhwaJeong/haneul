...
import (
	...
	"github.com/GeunhwaJeong/haneul/x/cw-hooks/types"
)
...
// 	s.SetupTest()
// 	_, _, sender := testdata.KeyTestPubAddr()
// 	coin := sdk.NewCoins(sdk.NewCoin("stake", sdkmath.NewInt(10_000_000)), sdk.NewCoin("uhaneul", sdkmath.NewInt(10_000_000)))
