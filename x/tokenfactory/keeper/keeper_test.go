...
import (
	...
	"github.com/GeunhwaJeong/haneul/x/tokenfactory/keeper"
	"github.com/GeunhwaJeong/haneul/x/tokenfactory/types"
)
...
func (s *KeeperTestSuite) SetupTest() {
	...
	fundAccsAmount := sdk.NewCoins(sdk.NewCoin("uhaneul", sdkmath.NewInt(100000000)), sdk.NewCoin("usecond", sdkmath.NewInt(100000000)))
