...
// network. See https://docs.pyth.network/price-feeds/contract-addresses/haneul and
// https://pyth.network/developers/price-feed-ids for the canonical values.
export const TESTNET = {
	// A JSON-RPC endpoint. The Pyth SDK needs JSON-RPC; the Haneullabs Testnet
	// fullnode serves gRPC, so point this at a JSON-RPC provider or your own node.
	rpcUrl: 'https://rpc-testnet.haneulscan.xyz',
	// Pyth and Wormhole shared state objects on Haneul Testnet.
	...
	feeds: {
		'HANEUL/USD': '0x50c67b3fd225db8912a424dd4baed60ffdde625ed2feaaf283724f9608fea266',
	},
} as const;
// docs::/#config
