...
const buyerAddress = buyerKeypair.toHaneulAddress();
const sponsorAddress = sponsorKeypair.toHaneulAddress();
...
const price = 5_000_000_000n; // 5 HANEUL
const buyerKioskId = '0xBuyerKioskId';
const transferPolicyId = '0xTransferPolicyId';

// Withdraw from the buyer's address balance, then redeem to get a Coin<HANEUL>.
