...
The `sessions-*` files import from `@haneullabs/deepbook-v3/sessions`, a separate
...
`@haneullabs/deepbook-v3/predict`, which carries a record for each deployment its
