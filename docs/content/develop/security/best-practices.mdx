...
keywords:
  ...
  - key management
goal:
  description: Reader understands overview of security best practices on Haneul
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Ship
questions:
  - What is Security Best Practices in Haneul?
  - How does security best practices work on Haneul?
  - What are the security considerations for security best practices?
answer: Overview of security best practices on Haneul.
---

Overview of security best practices on Haneul.
...
For implementation patterns and code examples, see the [Access control](/develop/write-move/move-best-practices) section of the Move best practices guide and the [capability pattern example app](https://github.com/GeunhwaJeong/haneul-move-bootcamp/tree/solution/C1/capability).
