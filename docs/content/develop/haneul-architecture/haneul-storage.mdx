...
title: Storage
description: >-
  Historical data and storage pricing provide insights into the cost of
  operations on the Haneul network.
keywords:
  - storage
...
goal:
  description: >-
    Reader understands historical data and storage pricing provide insights into
    the cost of operations on the Haneul network
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Storage in Haneul?
  - How does storage work on Haneul?
...
You can run this query in your browser at https://graphql.mainnet.haneulfoundation.org/graphql
