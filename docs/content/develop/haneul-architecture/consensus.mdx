...
keywords:
  ...
  - dpos
goal:
  description: Reader understands overview of the Haneul consensus mechanism
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Consensus in Haneul?
  - How does consensus work on Haneul?
  - Why should I use consensus?
answer: Overview of the Haneul consensus mechanism.
---
