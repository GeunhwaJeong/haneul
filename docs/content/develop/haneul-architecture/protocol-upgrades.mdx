...
description: >-
  The Haneul protocol, framework, and execution engine are frequently extended to
  include new functionality and bug fixes. The upgrade process ensures all
  clients use the same source.
keywords:
  - protocol upgrades
  - framework upgrades
  - protocol config
...
goal:
  description: >-
    Reader understands how Haneul ships protocol and framework upgrades that
    validators adopt in lockstep
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Protocol Upgrades in Haneul?
  - How does protocol upgrades work on Haneul?
  - Why should I use protocol upgrades?
answer: >-
  The Haneul protocol, framework, and execution engine are frequently extended to
  include new functionality and bug fixes.
---
