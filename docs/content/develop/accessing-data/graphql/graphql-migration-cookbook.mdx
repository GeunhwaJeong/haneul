...
- **Mainnet:** https://graphql.mainnet.haneulfoundation.org/graphql
- **Testnet:** https://graphql.testnet.haneulfoundation.org/graphql
- **Devnet:** https://graphql.devnet.haneulfoundation.org/graphql
...
```sh
curl -X POST https://fullnode.mainnet.haneulfoundation.org:443 \
  -H "Content-Type: application/json" \
  -d '{
    "jsonrpc": "2.0",
    "id": 1,
...
The public URLs at `https://graphql.<NETWORK>.haneulfoundation.org/graphql` are rate-limited and intended for development. Production apps should use a provider endpoint or operate their own [GraphQL and Indexer stack](/operators/data-management/indexer-stack-setup).
