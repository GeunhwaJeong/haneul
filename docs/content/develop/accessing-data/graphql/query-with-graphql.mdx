...
description: >-
  Practical guide to making queries of the Haneul RPC using the GraphQL service,
...
goal:
  description: >-
    Reader understands practical guide to making queries of the Haneul RPC using
...
questions:
  ...
  - What is Querying Data with GraphQL RPC in Haneul?
...
```sh
$ curl -i -X POST https://graphql.testnet.haneulfoundation.org/graphql\
...
When using the [GraphQL online integrated development environment (IDE)](https://graphql.mainnet.haneulfoundation.org/graphql), supply variables as a JSON object to the query in the **Variables** pane at the bottom of the main editing window. You receive a warning if you supply a variable but don't declare it.
