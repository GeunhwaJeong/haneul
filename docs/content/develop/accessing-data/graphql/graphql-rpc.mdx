...
GraphQL RPC Server and the General-purpose Indexer are generally available. JSON-RPC is deprecated. Haneul Foundation disabled it on Mainnet full nodes the week of July 27, 2026, and plans full decommission for mid-October 2026. See the [JSON-RPC Migration Guide](/develop/accessing-data/json-rpc-migration) for the complete timeline.
