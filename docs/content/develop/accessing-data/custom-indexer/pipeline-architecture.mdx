...
description: >-
  The `haneul-indexer-alt-framework` provides two distinct pipeline architectures.
  Understand the differences between the sequential and concurrent pipelines
  that the `haneul-indexer-alt-framework` provides to decide which best haneults your
  project needs.
keywords:
  - indexer
  - index data
...
goal:
  description: >-
    Reader understands the `haneul-indexer-alt-framework` provides two distinct
...
questions:
  - What is Indexer Pipeline Architecture in Haneul?
  - When to use each pipeline?
  - How does indexer pipeline architecture work on Haneul?
answer: >-
  The `haneul-indexer-alt-framework` provides two distinct pipeline architectures.
  Understand their differences to choose the right approach.
---
