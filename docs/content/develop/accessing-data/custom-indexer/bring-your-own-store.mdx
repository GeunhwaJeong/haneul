...
goal:
  description: >-
    Reader can implement a custom storage backend for the customer indexer
    framework
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Bring Your Own Store (BYOS) in Haneul?
  - How does bring your own store (byos) work on Haneul?
  - Why should I use bring your own store (byos)?
answer: Implement a custom storage backend for the customer indexer framework.
---
    ...
    let indexer = Indexer::new(
        ...
        ClientArgs {
            ...
            streaming: StreamingClientArgs {
                ...
                streaming_url: Some("https://fullnode.testnet.haneulfoundation.org:443".parse()?),
                ..Default::default()
            },
            ..Default::default()
        },
