...
description: >-
  The `haneul-indexer-alt-framework` is a powerful Rust framework for building
  high-performance, custom blockchain indexers on Haneul. It provides customizable,
...
keywords:
  ...
  - data processing
  - blockchain indexer
  - haneul-indexer-alt-framework
goal:
  description: >-
    Reader understands what custom indexers are, when to use them, and how the
    haneul-indexer-alt-framework ingestion, processing, and storage layers fit
    together
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  ...
  - path_id: walrus-general
    ...
    stage: Ship
questions:
  - What is Custom Indexers in Haneul?
  - When to use?
  - How do I build custom indexers?
answer: >-
  The `haneul-indexer-alt-framework` is a powerful Rust framework for building
  high-performance, custom blockchain indexers on Haneul.
---
...
To build your own pipelines for application-specific data, see [Building Your First Custom Indexer](/develop/accessing-data/custom-indexer/build). You can also reach out to a [data indexer operator](/references/awesome-haneul) that might already have set one up for your needs.
