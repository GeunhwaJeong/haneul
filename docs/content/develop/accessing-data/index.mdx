...
answer: >-
  Haneul provides multiple data access mechanisms: GraphQL RPC for flexible
...
Data access on Haneul is the process of reading onchain state, including [transactions](/develop/transactions/txn-overview), [checkpoints](/develop/haneul-architecture/checkpoint-verification), [objects](/develop/haneul-architecture/object-model), and [events](/develop/accessing-data/using-events). Haneul provides multiple interfaces for accessing this data, each optimized for different use cases.
