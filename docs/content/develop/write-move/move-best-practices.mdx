...
keywords:
  ...
  - module design
  - Haneul Move development
goal:
  description: Reader understands recommended Move best practices for Haneul development
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Move Best Practices in Haneul?
  - How does move best practices work on Haneul?
  - Why should I use move best practices?
answer: Recommended Move best practices for Haneul development.
---
