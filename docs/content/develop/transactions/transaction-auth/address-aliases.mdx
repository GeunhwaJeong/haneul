...
description: >-
  Address aliases can be used to configure the set of keys that are allowed to
  sign transactions for a particular address on the Haneul network.
keywords:
  - address aliases
  - aliases
  - key rotation
...
goal:
  description: >-
    Reader can use address aliases to configure which keys are allowed to sign
...
questions:
  - What is Address Aliases in Haneul?
  - Why should I use address aliases?
answer: >-
  Address aliases can be used to configure the set of keys that are allowed to
  sign transactions for a particular address on the Haneul network.
---
