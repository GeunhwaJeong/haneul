...
goal:
  description: >-
    Reader understands programmable transaction blocks are a group of commands
    that complete a transaction on Haneul
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is a PTB in Haneul?
  - How does a ptb work on Haneul?
  - Why should I use a ptb?
answer: >-
  If you connect to Localnet, verify your local node is running first. See
  [Connecting to a local network](/getting-started/onboarding/local-network).
---
