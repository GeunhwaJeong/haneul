...
Haneul has migrated data access from JSON-RPC to gRPC and GraphQL RPC. Haneul Foundation disabled JSON-RPC on Mainnet full nodes the week of July 27, 2026. The public full-node gRPC API does not include soft bundle execution. See [Haneul and Community SDKs](/references/haneul-sdks) for current SDK support.
