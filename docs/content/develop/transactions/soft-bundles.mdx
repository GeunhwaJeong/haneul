...
description: >-
  Submit a sequence of transactions from different signers so that Haneul orders
...
keywords:
  ...
  - gRPC
questions:
  - What is Soft Bundles in Haneul?
...
Haneul is migrating data access from JSON-RPC to gRPC and GraphQL RPC, with JSON-RPC disabled on Haneul Foundation mainnet full nodes the week of July 27, 2026. The public full-node gRPC API does not include soft bundle execution. See [Haneul and Community SDKs](/references/haneul-sdks) for current SDK support.
