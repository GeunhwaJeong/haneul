...
title: Gas Smashing
description: >-
  Haneul optimizes coin management by combining multiple coins into a single object
  to pay for gas fees.
keywords:
  - gas smashing
  - smash gas
  ...
  - compatibility coin reservation
goal:
  description: >-
    Reader understands haneul optimizes coin management by combining multiple coins
    into a single object to pay for gas fees
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: agentic-payments
    ...
    stage: Authorization
questions:
  - What is Gas Smashing in Haneul?
  - How does gas smashing work on Haneul?
  - How do I optimize gas smashing performance?
answer: >-
  If you are using the address balances feature, then you do not need to use gas
  smashing. Address balance gas payment removes the need to select or merge gas
  coins entirely.
---
