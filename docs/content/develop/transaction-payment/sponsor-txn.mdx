...
description: >-
  Sponsored transactions let you pay gas fees on behalf of another user,
  reducing onboarding friction for users who don't own HANEUL.
keywords:
...
goal:
  description: >-
    Reader understands sponsored transactions let you pay gas fees on behalf of
    another user
  requires:
    - has_frontmatter:
        - title
...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is Sponsored Transactions in Haneul?
  - How do I create sponsored transactions using a gasdata object?
  - How does sponsored transactions work on Haneul?
answer: >-
  A transaction on Haneul requires a gas payment to execute. The payment is a list
  of `0x2::coin::Coin<0x2::haneul::HANEUL>` objects.
---
...
- **Cap the gas budget per transaction.** Set a maximum gas budget that your sponsor address signs for (for example, 50,000,000 GEUNHWA). Do not sponsor transactions with arbitrarily large gas budgets.
