...
title: Gas Fees
description: >-
  A Haneul transaction must pay for both the computational cost of execution and
...
goal:
  description: >-
    Reader understands a Haneul transaction must pay for both the computational
    cost of execution
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  ...
  - path_id: agentic-payments
    ...
    stage: Authorization
questions:
  - What is Gas Fees in Haneul?
  - How does gas fees work on Haneul?
  - Why should I use gas fees?
answer: >-
  A Haneul transaction must pay for both the computational cost of execution and
  the long-term cost of storing the objects a transaction creates or mutates.
---
