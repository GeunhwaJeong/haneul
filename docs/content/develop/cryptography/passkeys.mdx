...
title: Passkey
description: >-
  Haneul supports the passkey signature scheme that enables you to sign in to apps
...
goal:
  description: >-
    Reader understands haneul supports the passkey signature scheme that enables
...
builder_paths:
  - path_id: p2p-payments
    ...
    stage: Auth
questions:
  - What is Passkey in Haneul?
  - How does passkey work on Haneul?
