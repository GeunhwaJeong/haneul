...
sidebar_label: ECVRF
description: >-
  Elliptic curve verifiable random function is a cryptographic algorithm that
  enables you to generate a random number and provide proof that the number used
  a secret key for generation.
keywords:
  - elliptic curve
  - elliptic
  - verifiable
...
goal:
  description: >-
    Reader understands how ECVRF generates a random number with a proof that it
    was produced using a secret key
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Elliptic Curve Verifiable Random Function in Haneul?
  - How does elliptic curve verifiable random function work on Haneul?
  - Why should I use elliptic curve verifiable random function?
answer: >-
  Elliptic curve verifiable random function is a cryptographic algorithm that
  enables you to generate a random number and provide proof that the number used
  a secret key for generation.
