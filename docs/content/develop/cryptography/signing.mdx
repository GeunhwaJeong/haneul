...
description: >-
  Haneul supports verification within Move smart contracts through several
...
goal:
  description: >-
    Reader understands haneul supports verification within Move smart contracts
...
questions:
  ...
  - What signature schemes does Haneul support for onchain verification?
  - What is Signature Verification in Move in Haneul?
answer: >-
  Haneul supports verification within Move smart contracts through several
  signature schemes.
---
...
```sh
git@github.com:GeunhwaJeong/fastcrypto.git
cd fastcrypto/
