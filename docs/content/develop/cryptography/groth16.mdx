...
questions:
  - What is Groth16 in Haneul?
  - How does groth16 work on Haneul?
...
The following example demonstrates how to create a Groth16 proof from a statement written in Circom and then verify it using the Haneul Move API. The API supports up to 8 public inputs.
