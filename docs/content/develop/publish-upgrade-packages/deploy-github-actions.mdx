...
keywords:
  ...
  - haneulup
questions:
  - How do I deploy haneul packages with github actions?
  - How do I test every pull request?
  - What is Deploy Haneul Packages with GitHub Actions in Haneul?
answer: >-
  Build a production-safe CI/CD pipeline that tests every pull request,
  automates Testnet publishing, and gates Mainnet publishing and upgrades behind
  manual approval.
  ...
  publish:
    ...
    steps:
      ...
      - name: Configure network and key
        ...
        run: |
          haneul client new-env --alias testnet --rpc https://fullnode.testnet.haneulfoundation.org:443
