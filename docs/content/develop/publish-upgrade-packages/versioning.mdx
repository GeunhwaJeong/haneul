...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Ship
questions:
  - What is Package Versioning in Haneul?
  - How does package versioning work on Haneul?
  - How do I upgrade package versioning?
answer: Versioning provides the ability to upgrade packages on the Haneul network.
---
