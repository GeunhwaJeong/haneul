...
questions:
  - What is Types of Object Ownership in Haneul?
  - What topics does Types of Object Ownership cover?
  - How does types of object ownership work on Haneul?
answer: >-
...
APIs expose consensus-address-owned objects with a `ConsensusAddressOwner` owner variant. Party objects are the public Move-facing way to create this ownership form with `haneul::party::Party` and `haneul::transfer::party_transfer` or `haneul::transfer::public_party_transfer`.
