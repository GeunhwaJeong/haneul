...
description: >-
  Address-owned objects are owned by a Haneul 32-byte address, which can either be
...
keywords:
  ...
  - address ownership
goal:
  description: Reader understands address-owned objects are owned by a Haneul 32-byte address
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Environment
questions:
  - What is Address-Owned Objects in Haneul?
