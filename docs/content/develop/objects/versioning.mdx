...
description: >-
  Haneul provides `Table` and `Bag` collections built using dynamic fields, but
...
goal:
  description: >-
    Reader understands how Haneul versions objects by (ID, version) and the
...
questions:
  - What is Object Versioning in Haneul?
  - How does object versioning work on Haneul?
