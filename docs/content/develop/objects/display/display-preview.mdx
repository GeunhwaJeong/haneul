...
questions:
  - What is Object Display Templates in Haneul?
  - How does object display templates work on Haneul?
...
Object Display templates define how your Haneul objects appear in wallets, explorers, and other clients. Each template maps a display property (for example, `name`, `description`, `image_url`) to a format string that references fields on your object using `{field_name}` syntax.
