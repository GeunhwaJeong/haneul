...
description: >-
  An Object Display must be explicitly created and then maintained by the
  package or type owner.
keywords:
  - Object Display
  - object
  - display
...
goal:
  description: >-
    Reader understands an Object Display must be explicitly created and then
    maintained by the package or type owner
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I create displays?
  - What is Creating Displays in Haneul?
  - How does creating displays work on Haneul?
answer: >-
  Object Display V2 is the current Object Display standard. If you manage a
  display from Move code, use the `haneul::display_registry` APIs.
---
