...
description: >-
  Object Display is a way to render any object on Haneul using templating syntax.
  It renders Haneul Move object values into human-readable strings, JSON, or
...
goal:
  description: >-
    Reader understands object Display is a way to render any object on Haneul using
    templating syntax
  requires:
    - has_frontmatter:
        - title
