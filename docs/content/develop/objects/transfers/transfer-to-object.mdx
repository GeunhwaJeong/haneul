...
The core receiving interface in Move is defined in the [`transfer`](https://docs.haneulfoundation.org/references/framework/haneul_haneul/transferx) module in the Haneul framework:
