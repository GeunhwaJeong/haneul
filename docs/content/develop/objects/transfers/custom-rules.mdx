...
description: >-
  Custom transfer rules enable you to define a set of rules that must be met
  before Haneul considers a transfer operation valid.
keywords:
...
goal:
  description: >-
    Reader can define custom transfer rules that must be satisfied before Haneul
    considers a transfer valid
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Custom Object Transfer Rules in Haneul?
  - How does custom object transfer rules work on Haneul?
  - Why should I use custom object transfer rules?
answer: >-
  Custom transfer rules enable you to define a set of rules that must be met
  before Haneul considers a transfer operation valid.
---
