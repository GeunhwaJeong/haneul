...
description: >-
  Use the borrow module in the Haneul framework to include objects by reference in
  your programmable transaction blocks.
keywords:
  - borrow module
  - haneul framework
  - objects
  ...
  - Haneul API
  - references
  - simulate a reference
  - simulate references
goal:
  description: >-
    Reader can use the borrow module in the Haneul framework to include objects by
    reference in your programmable transaction blocks
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Simulating References in Haneul?
  - How does simulating references work on Haneul?
  - Why should I use simulating references?
answer: >-
  Use the borrow module in the Haneul framework to include objects by reference in
  your programmable transaction blocks.
---
