...
description: >-
  Derived objects enable deterministic object addresses, Transfer-to-Object
  capabilities, guaranteed uniqueness, and native parallelization for building
  scalable composable systems on Haneul.
keywords:
  - Derived objects
...
goal:
  description: >-
    Reader understands derived objects enable deterministic object addresses,
    Transfer-to-Object capabilities
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Derived Objects in Haneul?
  - How does derived objects work on Haneul?
  - Why should I use derived objects?
answer: >-
  Derived objects enable deterministic object addresses, Transfer-to-Object
  capabilities, guaranteed uniqueness, and native parallelization for building
  scalable composable systems on Haneul.
