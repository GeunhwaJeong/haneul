...
Devnet data is wiped regularly as part of [weekly scheduled software updates](https://haneulfoundation.org/networkinfo).
...
For more information about the release schedule of Haneul networks, see [Haneul Network Release](https://haneulfoundation.org/networkinfo/).
