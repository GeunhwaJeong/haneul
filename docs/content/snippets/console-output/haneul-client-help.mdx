...
Commands:
  ...
  gas                         Obtain all gas objects and the total HANEUL balance for the address. An
                                  address' alias can be used instead of the address
  ...
  verify-source               Verify local Move packages against onchain packages by rebuilding
                                  with the original publishing toolchain
