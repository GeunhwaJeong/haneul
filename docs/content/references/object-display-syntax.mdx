...
description: >-
  Learn how to use Display V2 format strings to render Haneul Move object values
...
goal:
  description: >-
    Reader can use Display V2 format strings to render Haneul Move object values
...
questions:
  - What is Object Display V2 Syntax in Haneul?
  - Where can I find the object display v2 syntax reference?
  - How does object display v2 syntax work on Haneul?
answer: >-
  Display V2 is a template language for rendering Haneul Move object values into
