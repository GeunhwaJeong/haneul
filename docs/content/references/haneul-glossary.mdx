...
goal:
  description: Reader can look up unfamiliar Haneul terms and concepts by name
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Glossary in Haneul?
  - Where can I find the glossary reference?
  - How does glossary work on Haneul?
answer: Find terms used in Haneul defined below.
---
