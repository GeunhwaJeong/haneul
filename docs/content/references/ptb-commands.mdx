...
title: PTB Commands
description: >-
  This topic describes each PTB command and their format, return type, and
  signature.
keywords:
...
goal:
  description: 'Reader can look up each PTB command''s form, return type, and signature'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is PTB Commands in Haneul?
  - Where can I find the ptb commands reference?
  - How does ptb commands work on Haneul?
answer: >-
  The following sections describe each PTB command. Command signatures shown are
  conceptual Move representations, as these operations cannot always be
  expressed as standard Move functions.
---
