...
keywords:
  ...
  - debugging
goal:
  description: 'Reader can look up trace analysis command syntax, flags, and usage examples'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Haneul Trace Analysis in Haneul?
  - What are the available haneul trace analysis commands?
  - What flags does haneul trace analysis support?
answer: Use the Haneul CLI to analyze transaction traces.
---
