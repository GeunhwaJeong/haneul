...
keywords:
  ...
  - execution traces
goal:
  description: 'Reader can look up replay cli command syntax, flags, and usage examples'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Haneul Replay CLI in Haneul?
  - What are the available haneul replay cli commands?
  - What flags does haneul replay cli support?
answer: >-
  Replay is a tool that allows you to replay a given transaction to check and
  analyze the transaction effects. The replay tool locally executes the
  transaction and compares its effects to the effects that exist on chain.
---
