...
title: Haneul RPC
description: >-
  HaneulJSON is a JSON-based format that enables alignment of JSON inputs with Move
  call arguments.
keywords:
  - HaneulJSON
  - json
...
goal:
  description: Reader can look up how HaneulJSON aligns JSON inputs with Move call arguments
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Haneul RPC in Haneul?
  - Where can I find the haneul rpc reference?
  - How does haneul rpc work on Haneul?
answer: >-
  HaneulJSON is a JSON-based format with restrictions that allow Haneul to align JSON
  inputs more closely with Move call arguments.
---
...
| ------- | -------------------------------------------- | ---------------------------------------------------------------------------------------- |
| Number  | Must be unsigned integer                     | u8, u16, u32, u64 (encoded as String), u128 (encoded as String), u256 (encoded as String) |
