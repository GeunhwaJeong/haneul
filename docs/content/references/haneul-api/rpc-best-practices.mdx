...
keywords:
  ...
  - rpc settings
goal:
  description: Reader can apply RPC best practices when configuring RPC provider settings
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is RPC Best Practices in Haneul?
  - Where can I find the rpc best practices reference?
  - How does rpc best practices work on Haneul?
answer: Consider RPC best practices when configuring your RPC settings.
---
