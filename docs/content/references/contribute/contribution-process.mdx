...
description: >-
  Help the Haneul community through documentation contributions. Whether it's to
  fix errors or add new content, the entire Haneul community benefits from your
  contributions.
keywords:
  - contribute docs
  - style guide compliance
  - add new docs page
  - change existing docs page
pagination_prev: null
goal:
  description: >-
    Contributor can edit Haneul docs via the GitHub web editor or a local
    environment and understands the review process
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Contribute to Haneul Documentation in Haneul?
  - How do I set up a local environment local-environment?
  - Where can I find the contribute to haneul documentation reference?
answer: >-
  Help the Haneul community through documentation contributions. Whether it's to
  fix errors or add new content, the entire Haneul community benefits from your
  contributions.
