...
description: >-
  Standards and guidelines for creating technical diagrams in Haneul documentation,
...
questions:
  - What is Technical Diagram Standards in Haneul?
  - Where can I find the technical diagram standards reference?
  - How does technical diagram standards work on Haneul?
answer: >-
  Standards and guidelines for creating technical diagrams in Haneul documentation,
  including the C4 model, brand style, tooling, diagram types, and export
  requirements.
...
- Use consistent terminology across all diagrams. Refer to the [Style Guide](https://docs.haneulfoundation.org/style-guide) for canonical names.
