...
description: >-
  Get the background information you need before you start developing on Haneul.
  Learn the layout of the Haneul monorepository and the suggested development
...
keywords:
  ...
  - monorepo
  - fork haneul repo
  - how to contribute to haneul repo
  - contribute to haneul
  - develop haneul locally
goal:
  description: >-
    Contributor understands the environment setup requirements for the Haneul
    documentation
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Haneul Environment Setup in Haneul?
  - Where can I find the haneul environment setup reference?
  - How does haneul environment setup work on Haneul?
answer: >-
  Before you start developing with Haneul and Move, you should familiarize yourself
  with how to contribute to Haneul, how Haneul is structured, what tools and SDKs
...
- [typescript-sdk](https://github.com/GeunhwaJeong/ts-sdks/tree/main/packages/haneul): Haneul TypeScript SDK.
