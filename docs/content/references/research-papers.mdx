...
description: >-
  Research papers that are relevant to Haneul and that one or more Haneul team members
  have co-authored.
keywords:
  - research papers
  - haneul papers
...
goal:
  description: >-
    Reader can look up Haneul-relevant research papers co-authored by Haneul team
    members
  requires:
    - has_frontmatter:
        - title
