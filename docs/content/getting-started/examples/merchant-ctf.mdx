...
description: >-
  Buy a flag from a Move merchant contract by acquiring Testnet USDC and
  building a transaction that pays the exact amount required.
keywords:
  - example
  - ctf
  - merchant
...
goal:
  description: >-
    Reader can buy a flag from a Move merchant contract by acquiring Testnet
    USDC
  requires:
    - headings:
...
questions:
  - How do I accept USDC payments in a Haneul Move contract?
  - What does the merchant CTF example demonstrate?
  - How do I build a merchant payment flow on Haneul?
answer: >-
  Buy a flag from a Move merchant contract by acquiring Testnet USDC and
  building a transaction that pays the exact amount required.
---
