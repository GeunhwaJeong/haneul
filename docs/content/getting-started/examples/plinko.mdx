...
title: Plinko
description: >-
  Build a provably fair, gasless Plinko game on Haneul using onchain randomness and
  sponsored transactions through Enoki.
keywords:
  - example
  - plinko
  - onchain-randomness
...
goal:
  description: >-
    Reader can build a provably fair, gasless Plinko game on Haneul using onchain
    randomness and sponsored transactions through Enoki
  requires:
    - headings:
...
questions:
  - How do I build an onchain Plinko game on Haneul?
  - How do I use onchain randomness in a Move game?
  - What does the Plinko example demonstrate?
answer: >-
  Build a provably fair, gasless Plinko game on Haneul using onchain randomness and
  sponsored transactions through Enoki.
---
