...
description: >-
  Build a real-time event indexer that subscribes to Haneul checkpoints through
...
goal:
  description: >-
    Reader can build a real-time event indexer that subscribes to Haneul
...
questions:
  - How do I build a real-time event indexer for Haneul?
  - How do I subscribe to Haneul checkpoints via gRPC?
