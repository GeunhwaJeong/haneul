...
description: >-
  Analyze a staking contract with a time-accumulation vulnerability and exploit
  the receipt merging logic to claim the flag without waiting a full week.
keywords:
  - example
  - ctf
  - staking
...
concepts:
  ...
  - balance_management
goal:
  description: Reader can analyze a staking contract with a time-accumulation vulnerability
  requires:
    - headings:
...
questions:
  - How do I implement time-based staking rewards on Haneul?
  - What does the staking CTF example demonstrate?
  - How do I use epochs for time-accumulation in Move?
answer: >-
  Analyze a staking contract with a time-accumulation vulnerability and exploit
  the receipt merging logic to claim the flag without waiting a full week.
---
...
This creates a `keypair.json` file with a fresh Ed25519 key pair. [Fund this new address with Testnet HANEUL](https://faucet.haneulfoundation.org/).
