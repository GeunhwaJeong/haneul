...
description: >-
  Create deterministic Haneul objects whose IDs you can predict offchain before the
...
goal:
  description: >-
    Reader can create deterministic Haneul objects whose IDs you can predict
...
questions:
  - How do I create objects with predictable IDs on Haneul?
  - What are the four derivation strategies for Haneul objects?
