...
description: >-
  Control access to privileged operations in Move using capability objects that
  you can delegate, revoke, and compose.
keywords:
  - example
  - capability
  - access-control
...
goal:
  description: >-
    Reader can control access to privileged operations in Move using capability
    objects that you can delegate, revoke, and compose
  requires:
    - headings:
...
questions:
  - How do I implement the capability pattern in Haneul Move?
  - What is the capability pattern and when should I use it?
  - How do I delegate and revoke access with capability objects?
answer: >-
  Control access to privileged operations in Move using capability objects that
  you can delegate, revoke, and compose.
---
