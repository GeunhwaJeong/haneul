...
title: dApp Kit
description: >-
  Build a React frontend that connects a wallet, mints an NFT through a Move
  contract, queries owned objects, and refreshes the UI automatically using Haneul
  dApp Kit and React Query.
keywords:
  - example
  - dapp-kit
  - react
...
goal:
  description: >-
    Reader can build a React frontend that connects a wallet, mints an NFT
    through a Move contract, queries owned objects
  requires:
    - headings:
...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - How do I build a React frontend with Haneul dApp Kit?
  - How do I connect a wallet using dApp Kit?
  - How do I query owned objects with React Query and dApp Kit?
answer: >-
  Build a React frontend that connects a wallet, mints an NFT through a Move
  contract, queries owned objects, and refreshes the UI automatically using Haneul
  dApp Kit and React Query.
...
**Fix:** Verify the URLs in `dapp-kit.ts` match the current Haneul gRPC endpoints. The standard endpoints are `https://grpc.testnet.haneulfoundation.org` for Testnet and `https://grpc.mainnet.haneulfoundation.org` for Mainnet.
