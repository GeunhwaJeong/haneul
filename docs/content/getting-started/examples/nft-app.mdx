...
<CodeWalkthrough source="F1/move/hero/sources/hero.move" org="MystenLabs" repo="sui-move-bootcamp" branch="solution" language="move">
...
<ImportContent source="F1/app/my-first-haneul-dapp/src/components/ui/CreateHeroForm.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" branch="solution" fun="CreateHeroForm" />
...
<ImportContent source="F1/app/my-first-haneul-dapp/src/components/ui/HeroesList.tsx" mode="code" org="MystenLabs" repo="sui-move-bootcamp" branch="solution" fun="HeroesList" />
