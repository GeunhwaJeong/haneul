...
description: >-
  Build an end-to-end app with a Hero NFT Move contract and a React frontend
  that mints heroes, equips weapons, and queries onchain state.
keywords:
  - example
  - dapp
  - nft
...
goal:
  description: >-
    Reader can build an end-to-end app with a Hero NFT Move contract and a React
    frontend that mints heroes, equips weapons
  requires:
    - headings:
...
questions:
  - How do I build an NFT minting app on Haneul?
  - How do I connect a React frontend to an NFT Move contract?
  - How do I use PTBs to mint and equip NFTs?
answer: >-
  Build an end-to-end app with a Hero NFT Move contract and a React frontend
  that mints heroes, equips weapons, and queries onchain state.
---
