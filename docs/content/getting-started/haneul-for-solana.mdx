...
{/* TODO: Import code from HaneulLabs/haneul-typescript — show a basic PTB example using Transaction, splitCoins, and transferObjects.  TypeScript PTB that splits a coin from the gas coin and transfers the split amount to a recipient address */}
