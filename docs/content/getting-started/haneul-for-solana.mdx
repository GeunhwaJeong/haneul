...
goal:
  description: >-
    Solana developer can map their existing mental model to Haneul's object-centric
    equivalents and start building
  requires:
    - has_tables: true
      min: 2
    ...
    - pattern: Solana
      min: 3
      label: References Solana for comparison
    - has_questions: true
      label: Needs questions for AI search visibility
    - has_answer: true
      label: Needs answer summary for AI citation
questions:
  - How is Haneul different from Solana?
  - How do I migrate from Solana to Haneul?
  - How do I transition from Solana to Haneul?
answer: Build your first app on Haneul if you have Solana experience.
---
...
{/* TODO: Import code from GeunhwaJeong/haneul-typescript — show a basic PTB example using Transaction, splitCoins, and transferObjects.  TypeScript PTB that splits a coin from the gas coin and transfers the split amount to a recipient address */}
