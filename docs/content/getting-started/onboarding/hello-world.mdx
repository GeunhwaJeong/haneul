...
answer: >-
  ...
  programming on Haneul. You create programs on Haneul by writing and deploying smart
  contracts to the network.
---

<AgentPrompt
  prompt={"Clone the https://github.com/GeunhwaJeong/haneul-stack-hello-world example app, build and publish the Move package at move/hello-world to Testnet, then call its entry function and show me the resulting object and transaction on HaneulVision. Remember: The Move.toml uses edition = '2024' and does NOT need a [dependencies] section for Haneul — the framework is resolved automatically."}
/>
...
[Learn more](https://github.com/GeunhwaJeong/haneul/blob/main/external-crates/move/historical-versions/v1/crates/move-bytecode-verifier/README.md) about the Move Bytecode Verifier.
