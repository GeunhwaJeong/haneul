...
goal:
  description: >-
    Ethereum developer can map their existing mental model to Haneul's
...
questions:
  - How is Haneul different from Ethereum?
  - How do I migrate from Ethereum to Haneul?
  - How do I transition from Ethereum to Haneul?
answer: >-
  If you have worked with Ethereum Virtual Machine (EVM) before, the biggest
  difference when developing on Haneul is the programming language. Haneul uses
