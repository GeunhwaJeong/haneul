...
goal:
  description: >-
    Reader can build an end-to-end encrypted group messaging app on Haneul using
...
questions:
  - How do I add encrypted messaging to my app on Haneul?
  - What does the Haneul messaging chat example demonstrate?
  - How do I use the Haneul Messaging SDK for end-to-end encryption?
answer: >-
  Add end-to-end encrypted group messaging to an app using Seal threshold
  encryption, a Walrus-backed relayer, and onchain permission management.
---
...
- [x] [Node.js](https://nodejs.org/) 22 or later and [pnpm](https://pnpm.io/installation) 10.17.0 or later, per the [Messaging SDK installation requirements](/haneul-stack/messaging/installation), plus a [Rust toolchain](https://rustup.rs/) for the relayer.
...
For SDK installation and client setup, see [Installation](/haneul-stack/messaging/installation) and [Developer Setup](/haneul-stack/messaging/setup).
...
A complete implementation lives in [`haneul-stack-messaging`](https://github.com/GeunhwaJeong/haneul-stack-messaging). The `chat-app` directory holds the React frontend and `relayer` holds the Rust service.
