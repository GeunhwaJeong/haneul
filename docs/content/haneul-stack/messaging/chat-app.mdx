...
description: >-
  Build an end-to-end encrypted group messaging app on Haneul using Seal threshold
...
questions:
  - How do I build an encrypted chat app on Haneul?
...
VITE_HANEUL_RPC_URL=https://fullnode.testnet.haneulfoundation.org:443
...
```bash
$ cd relayer
$ cp .env.example .env  # fill in HANEUL_RPC_URL (https://fullnode.testnet.haneulfoundation.org:443 for testnet) and GROUPS_PACKAGE_ID (Deployed Groups SDK package ID)
```
