...
description: >-
  Learn how to deploy and manage static websites on Walrus using the
  site-builder CLI, with configuration, custom headers, and HaneulNS domain names.
keywords:
  - walrus sites
  - site-builder
  - static site
...
goal:
  description: >-
    Reader can deploy and manage static websites on Walrus using the
    site-builder CLI, with configuration, custom headers
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Onchain Websites with Walrus Sites in Haneul?
  - How do I deploy a site?
  - How does onchain websites with walrus sites work on Haneul?
answer: 'By the end of this guide, you can:.'
---
...
```bash
$ curl https://raw.githubusercontent.com/GeunhwaJeong/walrus-sites/refs/heads/$NETWORK/sites-config.yaml \
