...
description: >-
  ...
  file path or location. Integrating a custom Haneul Indexer with Walrus can
...
builder_paths:
  ...
  - path_id: walrus-agentic
    ...
    stage: Ship
questions:
  - What is Custom Indexer and Walrus in Haneul?
  - How does custom indexer and walrus work on Haneul?
