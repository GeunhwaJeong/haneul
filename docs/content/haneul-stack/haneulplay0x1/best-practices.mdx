...
goal:
  description: >-
    ...
    storage when developing for HaneulPlay0X1
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Best Practices in Haneul?
  - How does best practices work on Haneul?
  - Why should I use best practices?
answer: There are some best practices to consider when developing for HaneulPlay0X1.
---
