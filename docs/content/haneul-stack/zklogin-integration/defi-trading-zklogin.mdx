...
description: >-
  ...
  trading flow on Haneul using Enoki.
keywords:
  - zklogin
  - defi
  - trading
...
questions:
  ...
  - How do I build a gasless trading experience on Haneul?
answer: >-
...
DeFi applications on Haneul can use zkLogin to onboard users who do not have a Haneul wallet. Combined with Enoki's sponsored transactions, this creates a trading experience where the user signs in with Google, swaps tokens, and the application covers gas fees, eliminating the cold-start problem of needing HANEUL before you can trade.
