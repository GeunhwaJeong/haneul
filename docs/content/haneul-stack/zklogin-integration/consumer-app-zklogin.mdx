...
keywords:
  ...
  - cookbook
questions:
  - How do I build a consumer app on Haneul with invisible crypto onboarding?
...
Consumer applications targeting non-crypto users need to eliminate every point of friction in the onboarding flow. The Haneul stack provides three primitives that, when combined, create an invisible-crypto experience:

| **Primitive** | **What it handles** |
| --- | --- |
| [zkLogin](/haneul-stack/zklogin-integration) | Authentication: users sign in with Google, Apple, or other OAuth providers instead of managing keys |
| [Enoki](https://docs.enoki.haneul-labs.com/) | Managed infrastructure: handles salt storage, proof generation, and sponsored transactions behind a single API |
| [Seal](/haneul-stack/seal) | Encrypted storage: lets you gate access to content or data based on onchain conditions without exposing it publicly |
...
**Goal:** Users perform onchain actions without holding HANEUL or understanding gas.
...
See the [zkLogin for DeFi](/haneul-stack/zklogin-integration/defi-trading-zklogin) guide for a complete example of this flow with DeepBook swaps.
...
```typescript
import { SealClient, SessionKey } from '@haneullabs/seal';
...
- [zkLogin Integration Guide](/haneul-stack/zklogin-integration/integration-guide): implement zkLogin from scratch
- [Enoki documentation](https://docs.enoki.haneul-labs.com/): managed zkLogin and sponsored transactions
- [Seal documentation](/haneul-stack/seal): encrypted storage and access control
- [zkLogin Wallets](/onchain-finance/asset-custody/wallets/zk-login-wallets): wallet implementations using zkLogin
- [Sponsored Transactions](/develop/transaction-payment/sponsor-txn): how gas sponsorship works on Haneul