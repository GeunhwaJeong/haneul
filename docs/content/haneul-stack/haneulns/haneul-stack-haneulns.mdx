...
{/* TODO: Import code from HaneulLabs/haneul-typescript — show resolveNameServiceAddress example */}
{/* Description: Basic name-to-address resolution using HaneulClient.resolveNameServiceAddress */}

{/* TODO: Import code from HaneulLabs/haneul-typescript — show resolveNameServiceNames example */}
...
{/* TODO: Import code from HaneulLabs/haneulns-contracts or a Haneul example repo — show offchain verification pattern using getNameRecord with expiry and target address checks */}
