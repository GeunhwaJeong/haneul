---
title: HaneulNS Communities
description: HaneulNS Communities is a social identity layer on Haneul that enables you to join ecosystem-specific communities, claim subnames, and access community features with real-time analytics and social tooling.
keywords:
  - HaneulNS Communities
  - Haneul blockchain
  - subnames
...
goal:
  description: >-
    Reader understands how to join, create, and manage HaneulNS Communities,
...
questions:
  - What are HaneulNS Communities?
  - How do I join a HaneulNS community?
  - How do I create a HaneulNS community?
answer: >-
  HaneulNS Communities is a social identity layer on Haneul where you join
  ecosystem-specific communities by claiming subnames, with configurable WHO
  (asset ownership) and FEE (payment) requirements.
---

HaneulNS Communities is a social identity layer on Haneul. You can join ecosystem-specific communities by claiming subnames to unlock access to community-specific features, analytics, and subname distribution mechanics. Each community owns a dynamic community page, with real-time stats, token and NFT insights, and social layer tooling.

The HaneulNS Communities home page displays community-wide data, analytics, and social update widgets:

- **Community Showcase**: Displays the avatars for the top projects as voted on by the HaneulNS community.
...
- **Trending Community updates**: Displays related social feed activity across HaneulNS Communities.
- Additional widgets provide overviews on community status, health, and activity.

## Community pages

The entry point to every community is through a dedicated landing page. This is where HaneulNS Communities gathers community information and social feeds of community interest.
...
1. Select the community avatar from the HaneulNS Communities home page to open its dedicated page.
...
You must have a [HaneulNS name](https://haneulns.io) set as the default for the connected wallet address.
...
The **Avatar** is used to visually represent your community in various widgets across HaneulNS Communities.

The **Cover Photo** is used as the hero banner for the community page.

### Description

The **Haneul Name** field value is added automatically using the default HaneulNS name for the connected wallet. If you do not see a name, check that you have the correct wallet connected and that the HaneulNS name is set as the default for the address.
