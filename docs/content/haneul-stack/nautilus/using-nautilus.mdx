...
goal:
  description: >-
    Reader understands details on how to use Nautilus with the reproducible
    build template and knows when to use it
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Using Nautilus in Haneul?
  - How does using nautilus work on Haneul?
  - Why should I use using nautilus?
answer: Details on how to use Nautilus with the reproducible build template.
---
