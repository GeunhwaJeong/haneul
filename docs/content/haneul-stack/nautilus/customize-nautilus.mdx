...
description: >-
  Details on how to customize Nautilus server logic, test functionality locally,
  and manage the enclave.
keywords:
  - nautilus
  - using nautilus
...
goal:
  description: >-
    Reader understands details on how to customize Nautilus server logic, test
    functionality locally, and manage the enclave
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - 'What is Customizing, Testing, and Management in Haneul?'
  - How do I create custom server logic?
  - 'How does customizing, testing, and management work on Haneul?'
answer: >-
  Details on how to customize Nautilus server logic, test functionality locally,
  and manage the enclave.
---
