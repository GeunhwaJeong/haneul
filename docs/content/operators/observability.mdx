...
description: >-
  Set up and manage logging, tracing, metrics, and observability for Haneul
  validators and full nodes using structured logging and Prometheus.
keywords:
  - observability
  - logging
  - tracing
  ...
  - monitoring
goal:
  description: 'Operator can set up and manage logging, tracing, metrics, and observability'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I set up observability for a Haneul node?
  - What logging and tracing options are available for Haneul?
  - How do I configure Prometheus metrics for Haneul?
answer: Good observability capabilities are key to the development and growth of Haneul.
---
