...
description: >-
  A collection of the Prometheus Alertmanager rules that trigger alerts and
  warnings on Validator and Full nodes.
keywords:
  - validator
  - alerts
  - Prometheus
...
goal:
  description: >-
    Validator operator understands a collection of the Prometheus Alertmanager
...
questions:
  - What Prometheus alerts should I configure for a Haneul validator?
  - How do I set up Alertmanager for Haneul validator monitoring?
  - What are the critical alert thresholds for Haneul validators?
answer: >-
  A collection of the Prometheus Alertmanager rules that trigger alerts and
  warnings on Validator and Full nodes.
---
