...
goal:
  description: >-
    Validator operator can use the Haneul CLI to interact with a full node's
    validator commands
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What tools are available for Haneul validator operators?
  - How do I use the Haneul validator CLI tools?
  - How do I check my validator node health?
answer: Use the Haneul CLI to interact with a full node's validator commands.
---
