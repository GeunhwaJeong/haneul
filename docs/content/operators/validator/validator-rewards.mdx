...
goal:
  description: >-
    Validator operator can learn how Haneul calculates and distributes validator
    and staker rewards
  requires:
    - has_frontmatter:
        - title
...
questions:
  - How do Haneul validator rewards work?
  - How are staking rewards calculated on Haneul?
  - What is the validator commission rate on Haneul?
answer: Learn how Haneul calculates and distributes validator and staker rewards.
---
