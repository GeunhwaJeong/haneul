...
goal:
  description: >-
    Node operator can monitor Haneul node metrics to ensure the health and
...
questions:
  - How do I monitor a Haneul full node?
  - What Prometheus metrics does a Haneul node expose?
  - How do I set up alerts for my Haneul node?
answer: Monitor Haneul node metrics to ensure the health and performance of your node.
---
...
- **Node down:** `up{job="haneul-fullnode"} == 0` sustained for 2 minutes indicates the node is unreachable.
