...
description: >-
  Database snapshots of the Haneul network enable full node operators a way to
  bootstrap a full node without having to execute all the transactions that
  occurred after genesis.
keywords:
  - node snapshots
  - database snapshots
  - full node snapshots
  ...
  - rocksdb snapshot
  - restoring a node
  - restoring a full node
  - restoring from snapshot
  - managed snapshots
  - enabling snapshots
goal:
  description: >-
    Operator understands database snapshots of the Haneul network enable full node
    operators a way to bootstrap a full node
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I use Haneul database snapshots?
  - How do I restore a Haneul node from a snapshot?
  - Where can I download Haneul node snapshots?
answer: >-
  Database snapshots of the Haneul network enable full node operators a way to
  bootstrap a full node without having to execute all the transactions that
  occurred after genesis.
