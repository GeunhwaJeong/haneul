...
Do not use `https://checkpoints.mainnet.haneul.io` for Mainnet archival fallback. State sync rejects this endpoint. Use the [S3](/operators/data-management/available-data-stores#checkpoint-s3) or [GCS](/operators/data-management/available-data-stores#checkpoint-gcs) bucket instead.
