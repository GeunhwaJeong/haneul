...
| **Network** | **URL** |
| --- | --- |
| Mainnet | `https://formal-snapshot.mainnet.haneul.io` |
| Testnet | `https://formal-snapshot.testnet.haneul.io` |
