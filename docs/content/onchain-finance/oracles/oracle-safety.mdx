...
description: >-
  Oracle failure modes for DeFi on Haneul, what liquidations, collateral valuation,
...
- **`getFullnodeUrl('testnet')` calls return 404:** observed. The Haneullabs Testnet fullnode serves gRPC; the Pyth SDK needs JSON-RPC. Point the client at a JSON-RPC endpoint.
