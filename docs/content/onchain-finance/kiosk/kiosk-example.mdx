...
title: Haneul Kiosk
description: >-
  Kiosk is a decentralized system for commerce applications on Haneul. Kiosk is a
  part of the Haneul framework, native to the system, and available to everyone.
keywords:
  - kiosk
  - haneul kiosk
  - create a kiosk
  - create kiosk with haneul cli
  - kiosk SDK
  - TypeScript
  - kiosk owners
...
goal:
  description: >-
    Reader can open and configure a Haneul Kiosk and understands its guarantees for
    owners, buyers, marketplaces, and creators
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Haneul Kiosk in Haneul?
  - How does haneul kiosk work on Haneul?
  - Why should I use haneul kiosk?
answer: >-
  Kiosk is a decentralized system for commerce applications on Haneul. Kiosk is a
  part of the Haneul framework, native to the system, and available to everyone.
---
