...
title: Kiosk Apps
description: >-
  Kiosk apps are a way to extend the functionality of Haneul Kiosk while keeping
  the core functionality intact. You can develop apps to add new features to a
  kiosk without having to modify the core code or move the assets elsewhere.
keywords:
  - kiosk apps
  - basic kiosk apps
...
goal:
  description: >-
    Reader understands kiosk apps are a way to extend the functionality of Haneul
    Kiosk while keeping the core functionality intact
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Kiosk Apps in Haneul?
  - How does kiosk apps work on Haneul?
  - Why should I use kiosk apps?
answer: >-
  Kiosk apps are a way to extend the functionality of Haneul Kiosk while keeping
