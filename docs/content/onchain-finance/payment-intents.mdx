...
goal:
  description: >-
    Reader can use programmable transaction blocks to compile multi-step payment
    workflows into a single atomic transaction
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Payment Intents in Haneul?
  - How do I additional examples?
  - How does payment intents work on Haneul?
answer: >-
  Use programmable transaction blocks to compile multi-step payment workflows
  into a single atomic transaction.
---
