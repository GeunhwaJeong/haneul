...
description: >-
  Create NFTs on Haneul using the native object model, without needing a dedicated
  token standard.
keywords:
  - ERC-721
  - NFT
...
goal:
  description: >-
    Reader can create NFTs on Haneul using the native object model, without needing
    a dedicated token standard
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I create an NFT on Haneul?
  - What are the common use cases for NFTs on Haneul?
  - How do I set up Object Display for an NFT?
answer: >-
  On Haneul, every object is unique and has an owner, properties that other
  blockchains like Ethereum require a dedicated standard such as
  [ERC-721](https://erc721.org/) to achieve.
---
