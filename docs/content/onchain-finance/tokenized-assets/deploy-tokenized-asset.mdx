...
description: >-
  Publish the asset_tokenization and template packages on Haneul and interact with
  your tokenized asset using the CLI and TypeScript scripts.
keywords:
  - asset tokenization
  - deploy
  - publish
  ...
  - CLI
goal:
  description: Reader can publish the asset_tokenization and template packages on Haneul
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - How do I deploy a tokenized asset on Haneul?
  - How do I publish a tokenization package to Testnet or Mainnet?
  - What is the asset tokenization template?
answer: >-
  Publish the asset_tokenization and template packages on Haneul and interact with
  your tokenized asset using the CLI and TypeScript scripts.
---

Publish the asset_tokenization and template packages on Haneul and interact with your tokenized asset using the CLI and TypeScript scripts.
...
Asset tokenization ships as a template you fork rather than a package you install, because the `template` package is rewritten per asset through WASM bytecode manipulation. Start from the reference repository:
...
The `setup` directory holds the deployment scripts and the environment file the rest of this guide populates:
