...
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - 'How do I create fungible tokens: coin standard?'
  - How do I use the coin standard?
  - How do I check coin address balances?
  - 'What is Create Fungible Tokens: Coin Standard in Haneul?'
...
[View the full example](https://github.com/GeunhwaJeong/haneul-move-bootcamp/blob/main/I1) or learn more about the [Coin Standard](https://docs.haneulfoundation.org/onchain-finance/fungible-tokens/coin).
