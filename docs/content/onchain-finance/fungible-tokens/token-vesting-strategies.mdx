...
description: >-
  Implement a vesting strategy for your token launch on Haneul to strengthen
...
goal:
  description: >-
    Reader can implement a vesting strategy for your token launch on Haneul to
...
questions:
  - What is Token Vesting Strategies in Haneul?
  - How does token vesting strategies work on Haneul?
