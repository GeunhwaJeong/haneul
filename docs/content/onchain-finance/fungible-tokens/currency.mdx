...
description: >-
  The Haneul Currency Standard enables you to create a broad range of fungible
  tokens on the Haneul network using either the legacy coin creation or the
  centralized coin registry system.
sidebar_label: Currency
keywords:
  - haneul Currency Standard
  - erc-20
  - erc-20 equivalent
  - creating coins
  - Currency Standard
...
goal:
  description: >-
    Reader understands the Haneul Currency Standard enables you to create a broad
    range of fungible tokens on the Haneul network
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: p2p-payments
    ...
    step: Currency standard
    stage: Tokens
questions:
  - What is Currency Standard in Haneul?
  - How does currency standard work on Haneul?
  - Why should I use currency standard?
answer: >-
...
For a step-by-step guide, see [Create Fungible Tokens: Currency Standard](/onchain-finance/fungible-tokens/create-a-fungible-token).
