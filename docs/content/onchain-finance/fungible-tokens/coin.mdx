...
title: Coin Standard
description: >-
  The Coin standard enables you to create a broad range of fungible tokens on
  the Haneul network to satisfy a number of use cases.
sidebar_label: Coin
keywords:
  - haneul coin standard
  - erc-20
  - erc-20 equivalent
  - creating coins
  - coin standard
  ...
  - denylist object
  - coin metadata
  - create coin with SDK
  - use SDK to create coin
  - mint coin
  - minting coins
pagination_prev: null
goal:
  description: >-
    Reader understands how the Coin standard supports creating a broad range of
    fungible tokens on Haneul
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  ...
  - path_id: agentic-payments
    ...
    step: Coin/Balance representation
    stage: Environment
    eval: partial
builder_paths_source:
  ...
  snapshot: '2026-07-10'
questions:
  - What is Coin Standard in Haneul?
  - How does coin standard work on Haneul?
  - Why should I use coin standard?
answer: >-
  The Coin and Currency standards are both used to create fungible tokens.
  However, they use different creation methods and store metadata in a different
  type of object.
---

:::tip

The Coin and Currency standards are both used to create fungible tokens. However, they use different creation methods and store metadata in a different type of object. See [Choosing a Fungible Token Standard](/onchain-finance/fungible-tokens) for a side-by-side comparison.
