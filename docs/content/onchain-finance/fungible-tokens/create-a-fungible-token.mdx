...
keywords:
  ...
  - currency registry
goal:
  description: Reader can create currencies and mint coins and tokens on the Haneul network
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  ...
  - 'What is Create Fungible Tokens: Currency Standard in Haneul?'
  - 'Why should I use create fungible tokens: currency standard?'
answer: Learn how to create currencies and mint coins and tokens on the Haneul network.
---
...
<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/registries/coin_registry.move" mode="code" fun="claim_metadata_cap" signatureOnly />

### Update metadata

The `MetadataCap` holder can update the currency's display information:

<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/registries/coin_registry.move" mode="code" fun="set_name" signatureOnly />

<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/registries/coin_registry.move" mode="code" fun="set_description" signatureOnly />

<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/registries/coin_registry.move" mode="code" fun="set_icon_url" signatureOnly />

### Freeze metadata

To make metadata permanently immutable, delete the `MetadataCap`:

<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/registries/coin_registry.move" mode="code" fun="delete_metadata_cap" signatureOnly />
