...
description: Choose between Haneul's Coin Standard and Currency Standard for creating fungible tokens.
keywords:
  - fungible tokens
  - coin standard
  - currency standard
...
questions:
  - Should I use Coin Standard or Currency Standard on Haneul?
  - What is the difference between Coin and Currency on Haneul?
  - Which fungible token standard should I choose?
  - How do I create a fungible token on Haneul?
answer: >-
  Haneul offers two fungible token standards: the Coin Standard and the Currency
  Standard. The Currency Standard is recommended for new projects. This page
  compares both and helps you choose.
---

Haneul provides two standards for creating fungible tokens. Both produce `Coin<T>` objects that are fully interoperable with wallets, DeFi protocols, and address balances. The difference is in how you create, configure, and manage the token's metadata and supply.
