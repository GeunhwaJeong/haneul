...
title: Rules
description: >-
  Rule modules create programmable restrictions that apply to any action within
  a `TokenPolicy`.
keywords:
  - rule module
  - token rules
...
goal:
  description: >-
    Reader understands rule modules create programmable restrictions that apply
    to any action within a `TokenPolicy`
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Rules in Haneul?
  - How does rules work on Haneul?
