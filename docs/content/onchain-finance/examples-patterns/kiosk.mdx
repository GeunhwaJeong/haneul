...
description: >-
  Use the asset tokenization packages to create fractional NFTs and fungible
  tokenized assets on Haneul, with support for Kiosk-based transfer policies.
keywords:
  - asset tokenization
  - fractional NFT
  - tokenized asset
...
goal:
  description: >-
    Reader can use the Kiosk standard to join tokenized assets while enforcing
    transfer policies
  requires:
    - pattern: '```'
      min: 1
...
questions:
  - What is Kiosk Joining Patterns in Haneul?
  - How does kiosk joining patterns work on Haneul?
  - Why should I use kiosk joining patterns?
answer: >-
  Use the asset tokenization packages to create fractional NFTs and fungible
  tokenized assets on Haneul, with support for Kiosk-based transfer policies.
---
