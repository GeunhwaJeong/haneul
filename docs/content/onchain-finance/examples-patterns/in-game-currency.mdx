...
description: >-
  Use the Haneul Closed-Loop Token standard to create assets that you can use as
...
goal:
  description: >-
    Reader can use the Haneul Closed-Loop Token standard to create assets that you
...
questions:
  - What is In-Game Currencies in Haneul?
  - How does in-game currencies work on Haneul?
