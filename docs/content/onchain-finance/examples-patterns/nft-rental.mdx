...
5. **Use the rented NFT.** The borrower accesses the NFT through `borrow` (immutable reference) or `borrow_val` (mutable reference, for use cases where the NFT state changes during rental).
