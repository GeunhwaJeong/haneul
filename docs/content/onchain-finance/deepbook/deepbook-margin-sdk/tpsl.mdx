...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="addConditionalOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="cancelConditionalOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="cancelAllConditionalOrders" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="executeConditionalOrders" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="newCondition" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="newPendingLimitOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="newPendingMarketOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="conditionalOrderIds" signatureOnly />

### `conditionalOrder`

Query a specific conditional order by ID.

<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="conditionalOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="lowestTriggerAbovePrice,highestTriggerBelowPrice" signatureOnly />
