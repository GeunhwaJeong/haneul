...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="newMarginManager" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="newMarginManagerWithInitializer" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="shareMarginManager" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="depositDuringInitialization" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="depositBase,depositQuote,depositDeep" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="withdrawBase,withdrawQuote,withdrawDeep" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="borrowBase,borrowQuote" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="repayBase,repayQuote" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="liquidate" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="setMarginManagerReferral" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="unsetMarginManagerReferral" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="managerState" signatureOnly />

### `owner`, `deepbookPool`, `marginPoolId`

Query basic margin manager information.

<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="ownerByPoolKey,deepbookPool,marginPoolId" signatureOnly />

### `baseBalance`, `quoteBalance`, `deepBalance`

Query individual asset balances held in the margin manager.

<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="baseBalance,quoteBalance,deepBalance" signatureOnly />

### `borrowedShares`, `borrowedBaseShares`, `borrowedQuoteShares`, `hasBaseDebt`

Query borrowed position information.

<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="borrowedShares,borrowedBaseShares,borrowedQuoteShares,hasBaseDebt" signatureOnly />

### `balanceManager`, `calculateAssets`, `calculateDebts`

Query balance and debt information.

<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="balanceManager,calculateAssets,calculateDebts" signatureOnly />
