...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="mintSupplierCap" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="supplyToMarginPool" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="withdrawFromMarginPool" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="mintSupplyReferral" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="withdrawReferralFees" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="getId,deepbookPoolAllowed,supplyCap,maxUtilizationRate,protocolSpread,minBorrow" signatureOnly />

### Supply and borrow metrics

Query current supply and borrow amounts and shares.

<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="totalSupply,supplyShares,totalBorrow,borrowShares,lastUpdateTimestamp" signatureOnly />

### Interest rate

Query the current interest rate based on utilization.

<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="interestRate" signatureOnly />

### User positions

Query a supplier's position in the pool.

<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="userSupplyShares,userSupplyAmount" signatureOnly />
