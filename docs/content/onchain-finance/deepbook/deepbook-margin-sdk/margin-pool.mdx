...
description: >-
  Learn how to use the DeepBook Margin SDK to supply liquidity and manage
  positions in margin pools.
keywords:
  - margin pool
  - liquidity
  - supply
...
goal:
  description: >-
    Developer can use the DeepBook Margin SDK to supply liquidity and manage
    positions in margin pools
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  - path_id: defi-deepbook
    ...
    step: 'Margin SDK: Pool'
    stage: Margin
questions:
  - How do I use the Margin Pool SDK?
  - What is Margin Pool SDK in Haneul?
  - What methods does the Margin Pool SDK provide?
answer: >-
  Supplying liquidity to margin pools enables lenders to earn interest on their
  assets while providing borrowing capacity for margin traders.
---
