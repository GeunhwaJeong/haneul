...
description: >-
  Learn how to use the DeepBook Margin SDK to manage margin pools and system
  configuration.
keywords:
  - maintainer
  - margin pool admin
...
goal:
  description: >-
    Developer can use the DeepBook Margin SDK to manage margin pools and system
    configuration
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  - path_id: defi-deepbook
    ...
    step: 'Margin SDK: Maintainer'
    stage: Margin
questions:
  - How do I use the Maintainer SDK?
  - What is Maintainer SDK in Haneul?
  - What methods does the Maintainer SDK provide?
answer: >-
  Learn how to use the DeepBook Margin SDK to manage margin pools and system
  configuration.
---
