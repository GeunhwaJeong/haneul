...
title: Predict
description: >-
  Learn about the Predict shared object, public trading functions, liquidity
  functions, configuration reads, and emitted events.
keywords:
  - predict object
  - deepbook predict
  - mint
...
goal:
  description: >-
    Reader can learn about the Predict shared object, public trading functions,
    liquidity functions, configuration reads
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Predict in Haneul?
  - How does predict work on Haneul?
  - How do I configure predict?
answer: >-
  The `Predict` shared object is the main protocol entry point. It coordinates
  user actions across manager balances, oracle state, pricing config, risk
  config, and vault accounting.
---
