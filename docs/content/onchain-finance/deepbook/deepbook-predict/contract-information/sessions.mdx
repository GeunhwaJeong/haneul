...
The `@haneullabs/deepbook-v3/sessions` builders and the `@haneullabs/deepbook-v3/predict` facade disagree about slippage protection in both directions, and both differences favor the session key holder being explicit:
