...
- **HANEUL for gas:** Request it from a [Haneul Testnet faucet](/getting-started/onboarding/get-coins).
...
2. Request DUSDC through the token request form, then confirm you own a DUSDC coin with `haneul client objects`.
