...
- [x] A Testnet address funded with HANEUL for gas from a [Haneul Testnet faucet](/getting-started/onboarding/get-coins).
...
2. Request DUSDC, then confirm you own a DUSDC coin with `haneul client objects`.
