...
keywords:
  ...
  - deepbookv3
goal:
  description: Developer can use the DeepBookV3 SDK to interact with a swap-like interface
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: defi-deepbook
    ...
    stage: DeFi SDK
questions:
  - How do I use the Swaps SDK?
  - What is Swaps in Haneul?
  - What methods does the Swaps provide?
answer: Learn how to use the DeepBookV3 SDK to interact with a swap-like interface.
---
