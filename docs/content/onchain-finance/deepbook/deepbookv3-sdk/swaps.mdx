...
DeepBookV3 provides a swap-like interface commonly seen in automatic market makers (AMMs). The DeepBookV3 SDK provides functions to leverage the features of this interface. See [Swaps](/onchain-finance/deepbook/deepbookv3/contract-information/swaps) in the API section for more details.
...
<ImportContent source="packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="swapExactQuantity" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="GeunhwaJeong" repo="ts-sdks" fun="swapExactQuantityWithManager" signatureOnly/>
