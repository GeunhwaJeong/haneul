...
questions:
  ...
  - What is DeepBookV3 SDK in Haneul?
...
- **`@haneullabs/deepbook-v3/predict`:** DeepBook Predict, covering market discovery, quotes, minting and redeeming positions, PLP liquidity, typed receipts, and a client-side board pricer. See [DeepBook Predict](/onchain-finance/deepbook/deepbook-predict).
- **`@haneullabs/deepbook-v3/account`:** The shared onchain account primitive that Predict and the DeepBook core account wrapper build on. See [Accounts and Custody](/onchain-finance/deepbook/deepbook-predict/contract-information/predict-manager).
- **`@haneullabs/deepbook-v3/sessions`:** Time-limited trading sessions that let an ephemeral key trade for an account until a fixed expiry. See [Sessions](/onchain-finance/deepbook/deepbook-predict/contract-information/sessions).
