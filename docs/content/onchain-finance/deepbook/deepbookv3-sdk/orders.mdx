...
goal:
  description: Developer can use the DeepBookV3 SDK to leverage orders against pools
  requires:
    - has_frontmatter:
        - title
        - description
...
answer: Learn how to use the DeepBookV3 SDK to leverage orders against pools.
---
