...
questions:
  ...
  - What is Flash Loans SDK in Haneul?
...
A flash loan is one where you borrow and return loans from pools within a single programmable transaction block. The SDK exposes functions that allow you to implement this functionality. See [Flash Loans](/onchain-finance/deepbook/deepbookv3/contract-information/flash-loans) for more details on the API.
