...
title: Margin Risks
description: >-
  Understand the risks of margin trading on DeepBook, including liquidation,
  interest rate fluctuations, and how to protect your positions.
keywords:
  - margin risks
  - liquidation
  - leverage risks
...
goal:
  description: >-
    Reader understands the risks of margin trading on DeepBook, including
    liquidation and interest rate fluctuations
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: defi-deepbook
    ...
    stage: Margin
questions:
  - What is Margin Risks in Haneul?
  - How does margin risks work on Haneul?
  - Why should I use margin risks?
answer: >-
  Margin trading amplifies both gains and losses. Before using DeepBook Margin,
  you should understand the risks involved. This guide explains the key risks
  and provides concrete examples to help you make informed decisions.
---
...
When you borrow funds to trade, you must maintain a minimum [risk ratio](/onchain-finance/deepbook/deepbook-margin/contract-information/risk-ratio) (the ratio of your total assets to total debts). If your position's risk ratio falls to or below the **Liquidation Risk Ratio**, anyone can liquidate your position.
...
DeepBook Margin uses a [kinked interest rate model](/onchain-finance/deepbook/deepbook-margin/contract-information/interest-rates) where rates increase gradually up to an optimal utilization point, then spike dramatically.
...
DeepBook Margin supports [TPSL orders](/onchain-finance/deepbook/deepbook-margin/contract-information/tpsl) that automatically close your position:
