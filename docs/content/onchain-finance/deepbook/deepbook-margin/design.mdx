...
title: Design
description: >-
  Learn about DeepBook Margin design, including MarginPool, MarginManager, and
  MarginRegistry shared objects.
keywords:
...
goal:
  description: >-
    Reader can learn about DeepBook Margin design, including MarginPool,
    MarginManager, and MarginRegistry shared objects
  requires:
    - has_frontmatter:
        - title
        - description
...
answer: >-
  At a high level, the DeepBook Margin design revolves around four main shared
  objects that work together to enable leveraged trading:.
---
...
- `BalanceManager`: Inherited from DeepBookV3, used to source funds for trading. See [BalanceManager](/onchain-finance/deepbook/deepbookv3/contract-information/balance-manager) to learn more.
