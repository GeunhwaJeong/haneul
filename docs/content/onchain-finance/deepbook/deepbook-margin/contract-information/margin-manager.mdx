...
description: >-
  Learn about the margin manager and how it enables leveraged trading on
  DeepBook.
keywords:
  - margin manager
  - marginmanager
...
goal:
  description: >-
    Reader understands how the margin manager enables leveraged trading on
    DeepBook
  requires:
    - has_frontmatter:
        - title
...
builder_paths:
  - path_id: defi-deepbook
    ...
    step: 'Margin contract: Manager'
    stage: Margin
questions:
  - What is Margin Manager in Haneul?
  - How does margin manager work on Haneul?
  - Why should I use margin manager?
answer: >-
  Learn about the margin manager and how it enables leveraged trading on
  DeepBook.
---
...
The system emits this event when you create a new margin manager.
...
The system emits this event when you deposit collateral into a margin manager.
...
The system emits this event when you withdraw collateral from a margin manager.
...
The system emits this event when you borrow assets from a margin pool.
...
The system emits this event when you repay borrowed assets.
...
The system emits this event when a liquidator liquidates a margin manager.
