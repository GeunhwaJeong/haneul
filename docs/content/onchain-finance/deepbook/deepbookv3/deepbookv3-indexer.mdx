...
sidebar_label: DeepBookV3 Indexer
description: >-
  DeepBookV3 Indexer provides streamlined, real-time access to order book and
  trading data from the DeepBookV3 protocol. It acts as a centralized service to
  aggregate and expose critical data points.
keywords:
  - DeepBook Indexer
  - DeepBook
  - public indexer
...
goal:
  description: >-
    Reader understands DeepBookV3 Indexer provides real-time access to order
    book and trading data
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: defi-deepbook
    ...
    step: DeepBook event indexing
    stage: Advanced
questions:
  - What is DeepBookV3 Indexer in Haneul?
  - How does deepbookv3 indexer work on Haneul?
  - Why should I use deepbookv3 indexer?
answer: >-
  DeepBookV3 Indexer provides streamlined, real-time access to order book and
  trading data from the DeepBookV3 protocol. It acts as a centralized service to
  aggregate and expose critical data points.
