...
description: >-
  Learn about the DeepBook EWMA (Exponentially Weighted Moving Average) gas
...
goal:
  description: >-
    Reader can learn about the DeepBook EWMA (Exponentially Weighted Moving
    Average) gas price penalty system
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is EWMA Gas Price Penalty in Haneul?
  - When does the penalty apply?
  - How does ewma gas price penalty work on Haneul?
answer: >-
  Learn about the DeepBook EWMA (Exponentially Weighted Moving Average) gas
  price penalty system.
---
