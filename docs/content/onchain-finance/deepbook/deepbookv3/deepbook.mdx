---
title: DeepBookV3
description: A central limit order book that brings features and functionality to marketplaces on Haneul. Token exchanges that use the layer can offer transparency, a full range of trading options, and customer privacy.
keywords:
  [
    deepbook,
    deep book,
