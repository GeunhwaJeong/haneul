...
questions:
  - What is Design in Haneul?
  - How does design work on Haneul?
  - Why should I use design?
answer: >-
  At a high level, the DeepBookV3 design follows the following flow, which
  revolves around three shared objects:.
---
...
- `BalanceManager`: Sources a user's funds when placing orders. A single `BalanceManager` can be used between all pools. See [BalanceManager](/onchain-finance/deepbook/deepbookv3/contract-information/balance-manager) to learn more.

<p class="flex justify-center">![1](./images/architecture_deepbook-shared-objects_v1.svg)</p>
...
<p class="flex justify-center">![Pool Modules](./images/architecture_deepbook-pool-modules_v1.svg)</p>
...
<p class="flex justify-center">![DeepBookV3 Governance Timeline](./images/flowchart_deepbook-governance-lifecycle_v1.svg)</p>
...
<p class="flex justify-center">![Place limit order flow](./images/sequence_deepbook-place-limit-order_v1.svg)</p>
