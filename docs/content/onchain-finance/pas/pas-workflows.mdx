...
description: >-
  Learn how to move assets through the Permissioned Asset Standard (PAS) on Haneul
  using Accounts, Requests, and Policies.
keywords:
  - PAS
...
goal:
  description: >-
    Reader can move assets through the Permissioned Asset Standard (PAS) on Haneul
    using Accounts, Requests, and Policies
  requires:
    - has_frontmatter:
        - title
...
questions:
  - What is Permissioned Assets Actions in Haneul?
