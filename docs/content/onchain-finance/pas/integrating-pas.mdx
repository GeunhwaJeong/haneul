...
keywords:
  ...
  - integrate with pas
goal:
  description: Reader can integrate with the PAS standard
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Integrating with Permissioned Assets in Haneul?
  - How do I set up a policy for a currency?
  - How does integrating with permissioned assets work on Haneul?
answer: 'To integrate with the Permissioned Assets Standard (PAS), you must:.'
---
