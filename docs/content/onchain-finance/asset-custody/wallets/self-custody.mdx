...
description: >-
  Learn about self-custodial wallets on Haneul,
  how to integrate any Wallet Standard wallet into your app using Haneul dApp Kit.
keywords:
  - wallet
  - self-custodial
  - ledger
...
goal:
  description: >-
    Reader can learn about self-custodial wallets on Haneul
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: p2p-payments
    ...
    step: Self-custody wallets
    stage: Wallets & Funding
questions:
  - What is Self-Custodial Wallets in Haneul?
  - How does self-custodial wallets work on Haneul?
  - Why should I use self-custodial wallets?
answer: >-
  Learn about self-custodial wallets on Haneul, how to integrate any Wallet Standard wallet into your app using Haneul dApp Kit.
---
...
The [Haneul dApp Kit](https://sdk.haneul-labs.com/dapp-kit) is the official SDK for building Haneul apps. Any wallet that implements the Wallet Standard, including Ledger, is detected automatically and appears in the connection UI without any wallet-specific configuration.
