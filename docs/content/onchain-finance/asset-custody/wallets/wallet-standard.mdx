...
description: >-
  The Wallet Standard defines how apps can automatically discover and interact
  with wallets.
keywords:
...
goal:
  description: >-
    Reader understands the Wallet Standard defines how apps can automatically
    discover and interact with wallets
  requires:
    - has_frontmatter:
        - title
        - description
...
builder_paths:
  - path_id: p2p-payments
    ...
    step: Wallet Standard
    stage: Wallets & Funding
questions:
  - What is Wallet Standard in Haneul?
  - How does wallet standard work on Haneul?
  - Why should I use wallet standard?
answer: >-
  Browser extension wallets built for Haneul use the [Wallet
  Standard](https://github.com/wallet-standard/wallet-standard/).
---
