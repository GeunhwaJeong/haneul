...
title: Slush
description: >-
  Learn about Slush Wallet, its features, and how to integrate it into your
  wallet or app using the Slush Wallet SDK and Haneul dApp Kit.
keywords:
  - slush
  - slush wallet
  - wallet
  ...
  - registerSlushWallet
goal:
  description: 'Reader can learn about Slush Wallet, its features'
  requires:
    - has_frontmatter:
        - title
        - description
...
questions:
  - What is Slush in Haneul?
  - How does slush work on Haneul?
  - Why should I use slush?
answer: >-
  Slush is the official Haneul wallet built by Haneul Labs, available as a Chrome
  browser extension, an iOS app, an Android app, and a web app at
  [slush.app](https://slush.app).
---
