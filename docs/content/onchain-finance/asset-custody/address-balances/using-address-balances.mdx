...
```bash
buf curl --protocol grpc https://fullnode.testnet.haneulfoundation.org/haneul.rpc.v2.StateService/GetBalance \
    -d '{
        "owner": "<ADDRESS>",
...
# List all balances
buf curl --protocol grpc https://fullnode.testnet.haneulfoundation.org/haneul.rpc.v2.StateService/ListBalances \
    -d '{"owner": "<ADDRESS>"}'
```

### GraphQL

Copy the examples below into [GraphQL IDE (Testnet)](https://graphql.testnet.haneulfoundation.org/graphql) to try them out:
