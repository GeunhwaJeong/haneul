...
function graphqlFrontmatterPlugin() {
  return (_tree, file) => {
    ...
    // Paths look like: references/haneul-api/haneul-graphql/beta/reference/operations/queries/address.mdx
    //                   references/haneul-api/haneul-graphql/beta/reference/types/objects/gas-coin.mdx
    ...
    if (!fm.description) {
      fm.description = `Reference documentation for the ${title} ${category} in the Haneul GraphQL API.`;
    }
