...
export default function JsonRpc() {
  ...
  return (
    <Layout title={`Haneul API Reference (Legacy) | ${siteConfig.title}`}>
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "1rem" }}>
        <div className="legacy-api-banner" role="alert">
          ...
          <p>
            Haneul Foundation disabled JSON-RPC on Mainnet full nodes the week of
        ...
        <p>
          Complete reference for the legacy Haneul JSON-RPC API. Browse methods,
