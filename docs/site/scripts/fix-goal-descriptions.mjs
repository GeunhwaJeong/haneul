...
const FIXES = {
  ...
  'develop/accessing-data/grpc/what-is-grpc.mdx':
    'Reader understands how gRPC provides fast, type-safe access to Haneul network data',
  ...
  'develop/objects/transfers/custom-rules.mdx':
    'Reader can define custom transfer rules that must be satisfied before Haneul considers a transfer valid',
  ...
  'getting-started/onboarding/install-source.mdx':
    'Reader can build and install the Haneul framework from source, either locally or directly from GitHub',
  ...
  'onchain-finance/fungible-tokens/coin.mdx':
    'Reader understands how the Coin standard supports creating a broad range of fungible tokens on Haneul',
  ...
  'references/cli.mdx':
    'Reader can look up the Haneul CLI command groups for interacting with the network and the Move language',
  'references/fullnode-protocol.mdx':
    'Reader can look up the Haneul full node gRPC protocol available on all full nodes',
  'references/research-papers.mdx':
    'Reader can look up Haneul-relevant research papers co-authored by Haneul team members',
  'references/rust-sdk.mdx':
    'Reader can look up how to use the Haneul Rust SDK to interact with Haneul networks in Rust',
  'references/haneul-api.mdx':
    'Reader can look up how HaneulJSON aligns JSON inputs with Move call arguments',
  'references/haneul-graphql.mdx':
    'Reader can look up how to use the GraphQL RPC service to interact with the Haneul network',
};
