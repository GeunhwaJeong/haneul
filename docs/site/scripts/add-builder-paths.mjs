...
const BUILDER_PATHS = [
  {
    ...
    steps: [
      // ── Setup ──
      { step: 'Install Haneul CLI', stage: 'Setup', page: 'getting-started/onboarding/haneul-install.mdx', eval: 'covered' },
      { step: 'Scaffold frontend', stage: 'Setup', page: 'getting-started/examples/dapp-kit-frontend.mdx', eval: 'covered' },
      { step: 'TypeScript SDK', stage: 'Setup', page: null, eval: 'covered', note: 'External: sdk.haneul-labs.com' },
      { step: 'Developer tools', stage: 'Setup', page: 'getting-started/tooling.mdx', eval: null },
      // ── DeFi Primitives ──
      { step: 'Understand DeFi on Haneul', stage: 'DeFi Primitives', page: 'onchain-finance/deepbook/deepbookv3/deepbook.mdx', eval: 'partial' },
      ...
      { step: 'DEEP fees and funding', stage: 'DeFi Primitives', page: 'onchain-finance/deepbook/deepbookv3/contract-information/staking-governance.mdx', eval: null },
      { step: 'Order constraints', stage: 'DeFi Primitives', page: 'onchain-finance/deepbook/deepbookv3/contract-information/orders.mdx', eval: null },
      { step: 'Pool creation', stage: 'DeFi Primitives', page: 'onchain-finance/deepbook/deepbookv3/contract-information/permissionless-pool.mdx', eval: null },
      { step: 'Pool querying', stage: 'DeFi Primitives', page: 'onchain-finance/deepbook/deepbookv3/contract-information/query-the-pool.mdx', eval: null },
      { step: 'Swap mechanics', stage: 'DeFi Primitives', page: 'onchain-finance/deepbook/deepbookv3/contract-information/swaps.mdx', eval: null },
      ...
      { step: 'SDK: Pools', stage: 'DeFi SDK', page: 'onchain-finance/deepbook/deepbookv3-sdk/pools.mdx', eval: null },
      ...
      { step: 'Margin SDK overview', stage: 'Margin', page: 'onchain-finance/deepbook/deepbook-margin-sdk/deepbook-margin-sdk.mdx', eval: null },
      { step: 'Margin SDK: Orders', stage: 'Margin', page: 'onchain-finance/deepbook/deepbook-margin-sdk/orders.mdx', eval: null },
      { step: 'Margin SDK: Manager', stage: 'Margin', page: 'onchain-finance/deepbook/deepbook-margin-sdk/margin-manager.mdx', eval: null },
      ...
      // ── UX ──
      { step: 'zkLogin + sponsored tx', stage: 'UX', page: 'haneul-stack/zklogin-integration/zklogin.mdx', eval: 'missing' },
      // ── Operations ──
  ...
  },
  {
    ...
    steps: [
      ...
      // ── Auth ──
      { step: 'zkLogin overview', stage: 'Auth', page: 'haneul-stack/zklogin-integration/index.mdx', eval: null },
      { step: 'zkLogin setup', stage: 'Auth', page: 'haneul-stack/zklogin-integration/zklogin.mdx', eval: 'partial' },
      { step: 'zkLogin example', stage: 'Auth', page: 'haneul-stack/zklogin-integration/zklogin-example.mdx', eval: 'partial' },
      { step: 'OpenID provider config', stage: 'Auth', page: 'haneul-stack/zklogin-integration/developer-account.mdx', eval: null },
      ...
      // ── Gas ──
      { step: 'Gas mechanics', stage: 'Gas', page: 'develop/transaction-payment/gas-in-haneul.mdx', eval: null },
      ...
      { step: 'Recipient resolution (HaneulNS)', stage: 'Payment Flow', page: 'haneul-stack/haneulns/index.mdx', eval: 'missing' },
      { step: 'HaneulNS integration', stage: 'Payment Flow', page: 'haneul-stack/haneulns/haneul-stack-haneulns.mdx', eval: null },
  ...
  },
  {
    ...
    steps: [
      // ── Environment ──
      { step: 'Install toolchain', stage: 'Environment', page: 'getting-started/onboarding/haneul-install.mdx', eval: 'covered' },
      { step: 'Object model (ownership, shared)', stage: 'Environment', page: 'develop/haneul-architecture/object-model.mdx', eval: 'covered' },
      ...
      { step: 'Gas mechanics', stage: 'Authorization', page: 'develop/transaction-payment/gas-in-haneul.mdx', eval: null },
      ...
      { step: 'zkLogin for agent identity', stage: 'Authorization', page: 'haneul-stack/zklogin-integration/index.mdx', eval: null },
      // ── Money Movement ──
  ...
  },
  {
    ...
    steps: [
      // ── Environment ──
      { step: 'Install toolchain', stage: 'Environment', page: 'getting-started/onboarding/haneul-install.mdx', eval: 'covered' },
      { step: 'Walrus concepts', stage: 'Environment', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Storage resource, epochs & lifetime', stage: 'Environment', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      // ── Store ──
      { step: 'Choose upload path', stage: 'Store', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Store a blob', stage: 'Store', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Set blob lifetime', stage: 'Store', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      // ── Read & Verify ──
      { step: 'Retrieve blob', stage: 'Read & Verify', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Verify availability & integrity', stage: 'Read & Verify', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Store sensitive data (Seal)', stage: 'Read & Verify', page: 'haneul-stack/seal/haneul-stack-seal.mdx', eval: 'covered' },
      // ── Ship ──
      { step: 'Integrate into app', stage: 'Ship', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Walrus example app (OnlyFins)', stage: 'Ship', page: 'haneul-stack/walrus/only-fins.mdx', eval: null },
      { step: 'Walrus custom indexer', stage: 'Ship', page: 'haneul-stack/walrus/indexer-walrus.mdx', eval: null },
      { step: 'Custom indexer framework', stage: 'Ship', page: 'develop/accessing-data/custom-indexer/custom-indexers.mdx', eval: null },
      { step: 'Manage lifecycle', stage: 'Ship', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
  ...
  },
  {
    ...
    steps: [
      // ── Environment ──
      { step: 'Programmatic toolchain', stage: 'Environment', page: 'getting-started/onboarding/haneul-install.mdx', eval: 'covered' },
      { step: 'Object model for agent blobs', stage: 'Environment', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Storage resource & payment', stage: 'Environment', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Object model concepts', stage: 'Environment', page: 'develop/haneul-architecture/object-model.mdx', eval: null },
      { step: 'Address-owned objects', stage: 'Environment', page: 'develop/objects/object-ownership/address-owned.mdx', eval: null },
      { step: 'Wrapped objects', stage: 'Environment', page: 'develop/objects/object-ownership/wrapped.mdx', eval: null },
      // ── Agent Write ──
      { step: 'Programmatic store via SDK', stage: 'Agent Write', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Batch small blobs (Quilt)', stage: 'Agent Write', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Content addressing & metadata/tags', stage: 'Agent Write', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      ...
      // ── Verify & Secure ──
      { step: 'Encrypt agent state (Seal)', stage: 'Verify & Secure', page: 'haneul-stack/seal/haneul-stack-seal.mdx', eval: 'covered' },
      { step: 'Verify availability before acting', stage: 'Verify & Secure', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
      { step: 'Versioned datasets/immutable lineage', stage: 'Verify & Secure', page: 'haneul-stack/walrus/haneul-stack-walrus.mdx', eval: 'covered' },
