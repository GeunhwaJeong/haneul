...
//! Thin gRPC client over a Haneul fullnode, used for the two things the checkpoint stream does not
...
use haneul_rpc::proto::haneul::rpc::v2 as rpc;
...
pub struct RpcClient {
    client: haneul_rpc::client::Client,
}

impl RpcClient {
    pub fn new(url: Url) -> Result<Self> {
        Ok(Self {
            client: haneul_rpc::client::Client::new(url.to_string())
