...
/// Allows calling `haneul::scratch::add` as `.scratch_add(permit, key, value)`.
public use fun scratch::add as TxContext.scratch_add;

/// Allows calling `haneul::scratch::read` as `.scratch_read(permit, key)`.
public use fun scratch::read as TxContext.scratch_read;

/// Allows calling `haneul::scratch::remove` as `.scratch_remove(permit, key)`.
public use fun scratch::remove as TxContext.scratch_remove;

/// Allows calling `haneul::scratch::exists` as `.scratch_exists(permit, key)`.
public use fun scratch::exists as TxContext.scratch_exists;

/// Allows calling `haneul::scratch::exists_with_type` as `.scratch_exists_with_type(permit, key)`.
public use fun scratch::exists_with_type as TxContext.scratch_exists_with_type;

/// Allows calling `haneul::scratch::read_opt` as `.scratch_read_opt(permit, key)`.
public use fun scratch::read_opt as TxContext.scratch_read_opt;

/// Allows calling `haneul::scratch::remove_opt` as `.scratch_remove_opt(permit, key)`.
public use fun scratch::remove_opt as TxContext.scratch_remove_opt;

/// Allows calling `haneul::scratch::replace` as `.scratch_replace(permit, key, value)`.
public use fun scratch::replace as TxContext.scratch_replace;

/// Allows calling `haneul::scratch::get_do` as `.scratch_get_do!(permit, key, f)`.
public use fun scratch::get_do as TxContext.scratch_get_do;

/// Allows calling `haneul::scratch::get_mut_do` as `.scratch_get_mut_do!(permit, key, f)`.
public use fun scratch::get_mut_do as TxContext.scratch_get_mut_do;

/// Allows calling `haneul::scratch::get_fold` as `.scratch_get_fold!(permit, key, none, some)`.
public use fun scratch::get_fold as TxContext.scratch_get_fold;

/// Allows calling `haneul::scratch::get_mut_fold` as `.scratch_get_mut_fold!(permit, key, none, some)`.
public use fun scratch::get_mut_fold as TxContext.scratch_get_mut_fold;

/// Allows calling `haneul::scratch::internal_add` as `.scratch_internal_add!(key, value)`.
public use fun scratch::internal_add as TxContext.scratch_internal_add;

/// Allows calling `haneul::scratch::internal_read` as `.scratch_internal_read!(key)`.
public use fun scratch::internal_read as TxContext.scratch_internal_read;

/// Allows calling `haneul::scratch::internal_remove` as `.scratch_internal_remove!(key)`.
public use fun scratch::internal_remove as TxContext.scratch_internal_remove;

/// Allows calling `haneul::scratch::internal_exists` as `.scratch_internal_exists!(key)`.
public use fun scratch::internal_exists as TxContext.scratch_internal_exists;

/// Allows calling `haneul::scratch::internal_exists_with_type` as
...
/// Allows calling `haneul::scratch::internal_read_opt` as `.scratch_internal_read_opt!(key)`.
public use fun scratch::internal_read_opt as TxContext.scratch_internal_read_opt;

/// Allows calling `haneul::scratch::internal_remove_opt` as `.scratch_internal_remove_opt!(key)`.
public use fun scratch::internal_remove_opt as TxContext.scratch_internal_remove_opt;

/// Allows calling `haneul::scratch::internal_replace` as `.scratch_internal_replace!(key, value)`.
public use fun scratch::internal_replace as TxContext.scratch_internal_replace;

/// Allows calling `haneul::scratch::internal_get_do` as `.scratch_internal_get_do!(key, f)`.
public use fun scratch::internal_get_do as TxContext.scratch_internal_get_do;

/// Allows calling `haneul::scratch::internal_get_mut_do` as `.scratch_internal_get_mut_do!(key, f)`.
public use fun scratch::internal_get_mut_do as TxContext.scratch_internal_get_mut_do;

/// Allows calling `haneul::scratch::internal_get_fold` as
/// `.scratch_internal_get_fold!(key, none, some)`.
public use fun scratch::internal_get_fold as TxContext.scratch_internal_get_fold;

/// Allows calling `haneul::scratch::internal_get_mut_fold` as
