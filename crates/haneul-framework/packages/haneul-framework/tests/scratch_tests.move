...
#[test, expected_failure(abort_code = haneul::scratch::EEntryAlreadyExists)]
fun add_duplicate() {
    let mut ctx = tx_context::dummy();
...
#[test, expected_failure(abort_code = haneul::scratch::EEntryDoesNotExist)]
fun read_missing() {
...
#[test, expected_failure(abort_code = haneul::scratch::EEntryTypeMismatch)]
...
#[test, expected_failure(abort_code = haneul::scratch::EBorrowMarkerMismatch)]
