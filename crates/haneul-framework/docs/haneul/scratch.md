...
-  [Struct `BorrowMarker`](#haneul_scratch_BorrowMarker)
-  [Struct `BorrowMarkerKey`](#haneul_scratch_BorrowMarkerKey)
...
-  [Function `begin_borrow`](#haneul_scratch_begin_borrow)
-  [Function `end_borrow`](#haneul_scratch_end_borrow)
-  [Macro function `get_do`](#haneul_scratch_get_do)
-  [Macro function `get_mut_do`](#haneul_scratch_get_mut_do)
-  [Macro function `get_fold`](#haneul_scratch_get_fold)
-  [Macro function `get_mut_fold`](#haneul_scratch_get_mut_fold)
...
-  [Macro function `internal_get_do`](#haneul_scratch_internal_get_do)
-  [Macro function `internal_get_mut_do`](#haneul_scratch_internal_get_mut_do)
-  [Macro function `internal_get_fold`](#haneul_scratch_internal_get_fold)
-  [Macro function `internal_get_mut_fold`](#haneul_scratch_internal_get_mut_fold)
-  [Function `borrow_marker`](#haneul_scratch_borrow_marker)
...
<a name="haneul_scratch_BorrowMarker"></a>

## Struct `BorrowMarker`

Occupies a key's slot while <code><a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a></code>, <code><a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a></code>, or their mutable variants have the value of
...
<pre><code><b>public</b> <b>struct</b> <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;<b>phantom</b> V: drop&gt; <b>has</b> drop
</code></pre>
...
<a name="haneul_scratch_BorrowMarkerKey"></a>

## Struct `BorrowMarkerKey`

Key for the scratch entry that holds the monotonic counter backing <code><a href="../haneul/scratch.md#haneul_scratch_borrow_marker">borrow_marker</a></code>.


<pre><code><b>public</b> <b>struct</b> <a href="../haneul/scratch.md#haneul_scratch_BorrowMarkerKey">BorrowMarkerKey</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<a name="haneul_scratch_EBorrowMarkerMismatch"></a>

A borrow-style macro found a different <code><a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a></code> than it left in the slot.


<pre><code><b>const</b> <a href="../haneul/scratch.md#haneul_scratch_EBorrowMarkerMismatch">EBorrowMarkerMismatch</a>: u64 = 3;
</code></pre>
...
<a name="haneul_scratch_begin_borrow"></a>

## Function `begin_borrow`

Not intended for direct usage. Instead, call <code><a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a></code>, <code><a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a></code>, or their mutable variants,
which handle the borrow-style usage of the value.
Begins a "borrow" of <code>key</code>: removes and returns its value, leaving a unique <code><a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a></code> in
the slot so nothing can add to or read it until <code><a href="../haneul/scratch.md#haneul_scratch_end_borrow">end_borrow</a></code> restores the value. Returns the
value and the marker, which must be passed to <code><a href="../haneul/scratch.md#haneul_scratch_end_borrow">end_borrow</a></code>.
While it is not verified that the same value is restored, the intended usage is guaranteed
by the borrow-style macros (<code><a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a></code>, <code><a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a></code>, and their mutable variants).
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryDoesNotExist">EEntryDoesNotExist</a></code> if there is no entry for <code>key</code>.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryTypeMismatch">EEntryTypeMismatch</a></code> if the entry exists, but its value is not of type <code>V</code>.


<pre><code><b>public</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_begin_borrow">begin_borrow</a>&lt;K: <b>copy</b>, drop, V: drop&gt;(ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">haneul::scratch::Permit</a>&lt;K&gt;, key: K): (V, <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">haneul::scratch::BorrowMarker</a>&lt;V&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_begin_borrow">begin_borrow</a>&lt;K: <b>copy</b> + drop, V: drop&gt;(
    ctx: &<b>mut</b> TxContext,
    <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;K&gt;,
    key: K,
): (V, <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt;) {
    <b>let</b> value = <a href="../haneul/scratch.md#haneul_scratch_remove">remove</a>&lt;K, V&gt;(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key);
    <b>let</b> marker = <a href="../haneul/scratch.md#haneul_scratch_borrow_marker">borrow_marker</a>&lt;V&gt;(ctx);
    <a href="../haneul/scratch.md#haneul_scratch_add">add</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key, <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt;(marker.0));
    (value, marker)
}
</code></pre>
...
<a name="haneul_scratch_end_borrow"></a>

## Function `end_borrow`

Not intended for direct usage. Instead, call <code><a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a></code>, <code><a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a></code>, or their mutable variants,
which handle the borrow-style usage of the value.
Ends a "borrow" begun by <code><a href="../haneul/scratch.md#haneul_scratch_begin_borrow">begin_borrow</a></code>: removes the <code><a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a></code> from <code>key</code>'s slot and
restores <code>value</code>.
While it is not verified that the same value is restored, the intended usage is guaranteed
by the borrow-style macros (<code><a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a></code>, <code><a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a></code>, and their mutable variants).
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryDoesNotExist">EEntryDoesNotExist</a></code> if the borrow was already ended.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryTypeMismatch">EEntryTypeMismatch</a></code> if the entry exists, but its value is not a <code><a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt;</code>.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EBorrowMarkerMismatch">EBorrowMarkerMismatch</a></code> unless the slot still holds <code>marker</code>.


<pre><code><b>public</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_end_borrow">end_borrow</a>&lt;K: <b>copy</b>, drop, V: drop&gt;(ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">haneul::scratch::Permit</a>&lt;K&gt;, key: K, value: V, marker: <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">haneul::scratch::BorrowMarker</a>&lt;V&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_end_borrow">end_borrow</a>&lt;K: <b>copy</b> + drop, V: drop&gt;(
    ctx: &<b>mut</b> TxContext,
    <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;K&gt;,
    key: K,
    value: V,
    marker: <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt;,
) {
    <b>assert</b>!(<a href="../haneul/scratch.md#haneul_scratch_remove">remove</a>&lt;K, <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt;&gt;(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key) == marker, <a href="../haneul/scratch.md#haneul_scratch_EBorrowMarkerMismatch">EBorrowMarkerMismatch</a>);
    <a href="../haneul/scratch.md#haneul_scratch_add">add</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key, value);
}
</code></pre>
...
<a name="haneul_scratch_get_do"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R: drop&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">haneul::scratch::Permit</a>&lt;$K&gt;, $key: $K, $f: |&$V| -&gt; $R)
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R: drop&gt;(
    $ctx: &<b>mut</b> TxContext,
    $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;,
    $key: $K,
    $f: |&$V| -&gt; $R,
    ...
    <b>let</b> ctx = $ctx;
    <b>let</b> <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a> = $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>;
    <b>let</b> key = $key;
    <b>if</b> (!<a href="../haneul/scratch.md#haneul_scratch_exists">exists</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key)) <b>return</b>;
    <b>let</b> (value, marker) = <a href="../haneul/scratch.md#haneul_scratch_begin_borrow">begin_borrow</a>&lt;$K, $V&gt;(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key);
    $f(&value);
    <a href="../haneul/scratch.md#haneul_scratch_end_borrow">end_borrow</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key, value, marker);
}
</code></pre>
...
<a name="haneul_scratch_get_mut_do"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_mut_do">get_mut_do</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R: drop&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">haneul::scratch::Permit</a>&lt;$K&gt;, $key: $K, $f: |&<b>mut</b> $V| -&gt; $R)
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_mut_do">get_mut_do</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R: drop&gt;(
    $ctx: &<b>mut</b> TxContext,
    $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;,
    $key: $K,
    $f: |&<b>mut</b> $V| -&gt; $R,
    ...
    <b>let</b> key = $key;
    <b>if</b> (!<a href="../haneul/scratch.md#haneul_scratch_exists">exists</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key)) <b>return</b>;
    <b>let</b> (<b>mut</b> value, marker) = <a href="../haneul/scratch.md#haneul_scratch_begin_borrow">begin_borrow</a>&lt;$K, $V&gt;(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key);
    $f(&<b>mut</b> value);
    <a href="../haneul/scratch.md#haneul_scratch_end_borrow">end_borrow</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key, value, marker);
}
</code></pre>
...
<a name="haneul_scratch_get_fold"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">haneul::scratch::Permit</a>&lt;$K&gt;, $key: $K, $none: $R, $some: |&$V| -&gt; $R): $R
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R&gt;(
    $ctx: &<b>mut</b> TxContext,
    $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;,
    $key: $K,
    $none: $R,
    ...
    <b>let</b> <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a> = $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>;
    <b>let</b> key = $key;
    <b>if</b> (!<a href="../haneul/scratch.md#haneul_scratch_exists">exists</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key)) <b>return</b> ($none);
    <b>let</b> (value, marker) = <a href="../haneul/scratch.md#haneul_scratch_begin_borrow">begin_borrow</a>&lt;$K, $V&gt;(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key);
...
<a name="haneul_scratch_get_mut_fold"></a>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_mut_fold">get_mut_fold</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">haneul::scratch::Permit</a>&lt;$K&gt;, $key: $K, $none: $R, $some: |&<b>mut</b> $V| -&gt; $R): $R
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_get_mut_fold">get_mut_fold</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R&gt;(
    $ctx: &<b>mut</b> TxContext,
    $<a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>: <a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;,
    $key: $K,
    $none: $R,
...
<a name="haneul_scratch_internal_get_do"></a>

## Macro function `internal_get_do`

A wrapper for <code><a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a></code> that constructs the <code><a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;</code> directly.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryTypeMismatch">EEntryTypeMismatch</a></code> if the entry exists, but its value is not of type <code>$V</code>.


<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_do">internal_get_do</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R: drop&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $key: $K, $f: |&$V| -&gt; $R)
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_do">internal_get_do</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R: drop&gt;(
    $ctx: &<b>mut</b> TxContext,
    $key: $K,
    $f: |&$V| -&gt; $R,
) {
    <a href="../haneul/scratch.md#haneul_scratch_get_do">get_do</a>!&lt;$K, $V, $R&gt;($ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>(internal::permit&lt;$K&gt;()), $key, $f)
}
</code></pre>
...
<a name="haneul_scratch_internal_get_mut_do"></a>

## Macro function `internal_get_mut_do`

A wrapper for <code><a href="../haneul/scratch.md#haneul_scratch_get_mut_do">get_mut_do</a></code> that constructs the <code><a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;</code> directly.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryTypeMismatch">EEntryTypeMismatch</a></code> if the entry exists, but its value is not of type <code>$V</code>.


<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_mut_do">internal_get_mut_do</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R: drop&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $key: $K, $f: |&<b>mut</b> $V| -&gt; $R)
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_mut_do">internal_get_mut_do</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R: drop&gt;(
    $ctx: &<b>mut</b> TxContext,
    $key: $K,
    $f: |&<b>mut</b> $V| -&gt; $R,
) {
    <a href="../haneul/scratch.md#haneul_scratch_get_mut_do">get_mut_do</a>!&lt;$K, $V, $R&gt;($ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>(internal::permit&lt;$K&gt;()), $key, $f)
}
</code></pre>
...
<a name="haneul_scratch_internal_get_fold"></a>

## Macro function `internal_get_fold`

A wrapper for <code><a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a></code> that constructs the <code><a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;</code> directly.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryTypeMismatch">EEntryTypeMismatch</a></code> if the entry exists, but its value is not of type <code>$V</code>.


<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_fold">internal_get_fold</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $key: $K, $none: $R, $some: |&$V| -&gt; $R): $R
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_fold">internal_get_fold</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R&gt;(
    $ctx: &<b>mut</b> TxContext,
    $key: $K,
    $none: $R,
    $some: |&$V| -&gt; $R,
): $R {
    <a href="../haneul/scratch.md#haneul_scratch_get_fold">get_fold</a>!&lt;$K, $V, $R&gt;($ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>(internal::permit&lt;$K&gt;()), $key, $none, $some)
}
</code></pre>
...
<a name="haneul_scratch_internal_get_mut_fold"></a>

## Macro function `internal_get_mut_fold`

A wrapper for <code><a href="../haneul/scratch.md#haneul_scratch_get_mut_fold">get_mut_fold</a></code> that constructs the <code><a href="../haneul/scratch.md#haneul_scratch_Permit">Permit</a>&lt;$K&gt;</code> directly.
Aborts with <code><a href="../haneul/scratch.md#haneul_scratch_EEntryTypeMismatch">EEntryTypeMismatch</a></code> if the entry exists, but its value is not of type <code>$V</code>.


<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_mut_fold">internal_get_mut_fold</a>&lt;$K: <b>copy</b>, drop, $V: drop, $R&gt;($ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>, $key: $K, $none: $R, $some: |&<b>mut</b> $V| -&gt; $R): $R
</code></pre>
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_internal_get_mut_fold">internal_get_mut_fold</a>&lt;$K: <b>copy</b> + drop, $V: drop, $R&gt;(
    $ctx: &<b>mut</b> TxContext,
    $key: $K,
    $none: $R,
    $some: |&<b>mut</b> $V| -&gt; $R,
): $R {
    <a href="../haneul/scratch.md#haneul_scratch_get_mut_fold">get_mut_fold</a>!&lt;$K, $V, $R&gt;($ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>(internal::permit&lt;$K&gt;()), $key, $none, $some)
}
</code></pre>
...
<a name="haneul_scratch_borrow_marker"></a>

## Function `borrow_marker`

Returns a fresh <code><a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt;</code>, unique within the transaction, from a monotonic counter kept
in its own scratch entry.


<pre><code><b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_borrow_marker">borrow_marker</a>&lt;V: drop&gt;(ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">haneul::scratch::BorrowMarker</a>&lt;V&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../haneul/scratch.md#haneul_scratch_borrow_marker">borrow_marker</a>&lt;V: drop&gt;(ctx: &<b>mut</b> TxContext): <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>&lt;V&gt; {
    <b>let</b> <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a> = <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>(internal::permit&lt;<a href="../haneul/scratch.md#haneul_scratch_BorrowMarkerKey">BorrowMarkerKey</a>&gt;());
    <b>let</b> key = <a href="../haneul/scratch.md#haneul_scratch_BorrowMarkerKey">BorrowMarkerKey</a>();
    <b>let</b> n = <b>if</b> (<a href="../haneul/scratch.md#haneul_scratch_exists">exists</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key)) <a href="../haneul/scratch.md#haneul_scratch_remove">remove</a>&lt;<a href="../haneul/scratch.md#haneul_scratch_BorrowMarkerKey">BorrowMarkerKey</a>, u64&gt;(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key) <b>else</b> 0;
    <a href="../haneul/scratch.md#haneul_scratch_add">add</a>(ctx, <a href="../haneul/scratch.md#haneul_scratch_permit">permit</a>, key, n + 1);
    <a href="../haneul/scratch.md#haneul_scratch_BorrowMarker">BorrowMarker</a>(n)
}
</code></pre>
