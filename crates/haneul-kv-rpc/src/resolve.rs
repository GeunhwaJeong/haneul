...
mod tests {
    ...
    use bytes::Bytes;
    use haneul_kvstore::BigTableClient as InnerBigTableClient;
    use haneul_kvstore::testing::{MockBigtableServer, ReadRowsResponseOrder};
    ...
    ) -> Vec<haneul_kvstore::testing::ReadRowsCall> {
    ...
    async fn resolve_checkpoints_splits_fat_checkpoint_transaction_reads() {
        ...
        // the `haneul-kvstore` `get_transactions_stream_*` tests.
