...
use haneul_kvstore::BITMAP_INDEX_PIPELINE;
...
fn spawn_listener(
    ...
    builder: Server,
    ledger: KvRpcServer,
    rpc_metrics: Arc<haneul_rpc_api::RpcMetrics>,
    grpc_method_allowlist: haneul_rpc_api::GrpcMethodAllowlist,
    request_log_layer: haneullabs_network::request_log::GrpcRequestLogLayer,
    ...
    use haneul_rpc_api::RpcMetricsMakeCallbackHandler;
    ...
    Ok(haneul_futures::service::Service::new()
        .spawn(async move {
            server_future.await?;
            Ok(())
        })
...
impl KvRpcServer {
    ...
    pub async fn start_service(
        ...
        use haneul_rpc_api::{RpcMetrics, grpc_method_paths_from_file_descriptor_sets};
        ...
        let request_log_layer =
            haneullabs_network::request_log::GrpcRequestLogLayer::from_encoded_file_descriptor_sets(
