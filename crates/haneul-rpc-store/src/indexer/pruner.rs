...
///
/// Hot objects such as Clock and HaneulSystemState can be superseded in every
...
mod tests {
    ...
    fn seed_checkpoint_versions(
        ...
        for &(checkpoint, version) in rows {
            let (k, v) = object_version_by_checkpoint::store(
                id,
                checkpoint,
                haneul_types::base_types::SequenceNumber::from_u64(version),
            );
            batch
    ...
    fn retractions_stage_widest_range_per_object() {
        ...
        assert_eq!(
            ...
            Some(haneul_types::base_types::SequenceNumber::from_u64(3)),
    ...
    /// HaneulSystemState shape, superseded in every checkpoint) is cleared below
    ...
    fn retraction_point_deletes_deep_history() {
        ...
        assert_eq!(
            ...
            Some(haneul_types::base_types::SequenceNumber::from_u64(1_000)),
        ...
        assert_eq!(
            schema
                ...
                .unwrap(),
            Some(haneul_types::base_types::SequenceNumber::from_u64(42)),
    ...
    fn prune_history_cohort_retracts_object_version_by_checkpoint() {
        ...
        let ver = |n: u64| haneul_types::base_types::SequenceNumber::from_u64(n);
        let mut batch = db.batch();
    ...
    fn all_object_version_by_checkpoint_rows(
        ...
        schema
            ...
            .map(|res| {
                ...
                (
                    key,
                    haneul_types::base_types::SequenceNumber::from_u64(value.into_inner().version),
                )
            })
            .collect()
    }
