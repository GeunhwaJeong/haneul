...
use haneul_types::base_types::{AuthorityName, HaneulAddress, ObjectID};
pub use haneul_types::transaction_deny_rules::{DenyElementKind, TransactionDenyRules};
...
impl TransactionDenyConfig {
    ...
    pub fn get_address_deny_set(&self) -> &BTreeSet<HaneulAddress> {
