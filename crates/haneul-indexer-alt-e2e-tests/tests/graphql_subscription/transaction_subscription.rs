...
use haneul_indexer_alt_graphql::CTransaction;
...
fn sender_var(sender: HaneulAddress) -> Option<Value> {
...
/// Execute `n` matching HANEUL transfers in soft bundles of four (one bundle per checkpoint) and return
/// their digests.
