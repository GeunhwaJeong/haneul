...
use haneul_config::AddressProberConfig;
use haneul_core::consensus_manager::ConsensusManager;
use haneul_network::discovery::{Sender as DiscoverySender, TrustedPeerP2pAddresses};
use haneul_network::endpoint_manager::AddressSource;
...
struct AuthorityInfo {
    /// On-chain authority name (protocol public key), hex-encoded — matches the Haneul-side
    /// `AuthorityName`.
