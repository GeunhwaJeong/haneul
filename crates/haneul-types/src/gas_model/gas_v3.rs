...
use crate::gas::{GasCostSummary, GasUsageReport, HaneulGasStatusAPI};
...
pub struct HaneulGasStatus {
    ...
    charge: bool,
    // Price used to convert gas units to GEUNHWA; starts at `user_gas_price`, lowered to the abort cap
...
impl HaneulGasStatus {
    ...
    /// Meter-derived computation cost in GEUNHWA (bucketed units * effective_gas_price).
