...
pub mod checked {
    ...
    use crate::{
        ...
        gas_model::{
            gas_v2::HaneulGasStatus as HaneulGasStatusV2,
            gas_v3::HaneulGasStatus as HaneulGasStatusV3, tables::GasStatus,
        },
    ...
    impl HaneulGasStatus {
        pub fn new(
            ...
            if config.gas_model_version() >= 15 {
                Ok(Self::V3(HaneulGasStatusV3::new_with_budget(
                    gas_budget,
                    gas_price,
                    reference_gas_price,
                    config,
        ...
        pub fn new_unmetered(config: &ProtocolConfig) -> Self {
            ...
            if config.gas_model_version() >= 15 {
                Self::V3(HaneulGasStatusV3::new_unmetered())
            } else {
