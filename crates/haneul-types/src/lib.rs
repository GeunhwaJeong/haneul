...
built_in_ids! {
    ...
    HANEUL_FORWARDING_ADDRESS_REGISTRY_ADDRESS / HANEUL_FORWARDING_ADDRESS_REGISTRY_OBJECT_ID = 0xfa;
}
...
pub const IMPLICITLY_READ_SYSTEM_OBJECTS: &[ObjectID] = &[HANEUL_ACCUMULATOR_ROOT_OBJECT_ID];
