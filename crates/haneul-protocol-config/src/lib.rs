...
// Version 121: Record unsettled object-funds withdraws using per-account net amounts
...
// Version 123: Add native costs for `package::original_package_id` and reduce
...
// Version 126: Tracks upstream protocol version 136.
...
pub struct ProtocolConfig {
    ...
    // Maximum number of entries in the per-transaction `haneul::scratch` store.
    ...
    fn get_for_version_impl(version: ProtocolVersion, chain: Chain) -> Self {
        ...
        for cur in 2..=version.0 {
            match cur {
                ...
                121 => {
                    // v121 tracks upstream protocol version 130.
                ...
                123 => {
                    // v123 tracks upstream protocol version 134.
                    // The `original_package_id` native costs and the reduced consensus
                    // block limits shipped gated to non-mainnet chains, and only mainnet
                    // disables defer_unpaid_amplification; both gates are preserved
                    // exactly as released.
                    if chain != Chain::Mainnet {
                ...
                126 => {
                    // v126 tracks upstream protocol version 136.
