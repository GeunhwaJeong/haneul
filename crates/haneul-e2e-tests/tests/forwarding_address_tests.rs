...
/// protocol version 132, since only freshly-created networks get it at genesis. Genesis at
...
async fn test_create_forwarding_address_registry_object_at_upgrade() {
    ...
    let test_cluster = TestClusterBuilder::new()
        ...
        .with_supported_protocol_versions(SupportedProtocolVersions::new_for_testing(130, 132))
        .build()
        .await;
    ...
    test_cluster.wait_for_protocol_version(132.into()).await;
