...
mod test {
    ...
    async fn test_network_resilience_with_incorrect_discovery_addresses() {
        ...
        for name in &validator_names {
            ...
            config.address_prober = Some(haneul_config::AddressProberConfig {
    ...
    async fn test_prober_detects_bad_consensus_address() {
        ...
        test_cluster.stop_all_validators().await;
        let bad_consensus_addr: haneul_types::multiaddr::Multiaddr =
        ...
        let bad_consensus_label = test_cluster
            ...
            .unwrap()
            .with(|n| {
                haneul_node::address_prober::consensus_peer_label_for_testing(
