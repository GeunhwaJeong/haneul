...
use haneul_rpc::proto::haneul::rpc::v2::{ActiveJwk, Jwk, JwkId};
use haneul_test_transaction_builder::TestTransactionBuilder;
use haneul_types::base_types::{HaneulAddress, ObjectDigest, ObjectID};
...
async fn test_verify_signature_zklogin() -> Result<(), anyhow::Error> {
    ...
    for proof_json in [PINNED_V1_PROOF_JSON, PINNED_V2_PROOF_JSON] {
        ...
        let zklogin_addr = HaneulAddress::from(&PublicKey::from_zklogin_inputs(&inputs)?);
