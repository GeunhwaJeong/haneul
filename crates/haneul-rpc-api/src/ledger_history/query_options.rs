...
use haneul_rpc::proto::haneul::rpc::v2::Ordering as ProtoOrdering;
use haneul_rpc::proto::haneul::rpc::v2::QueryEndReason;
use haneul_rpc::proto::haneul::rpc::v2::QueryOptions as ProtoQueryOptions;
...
pub enum RangeExhaustion {
    ...
    CursorBound { kind: haneul_rpc_cursor::CursorKind },
}
    ...
    CursorToken: ScanCursor<P>,
{
    ...
    fn apply_after_cursor(
        &mut self,
        options: &QueryOptions,
    ) -> Option<(u64, P, haneul_rpc_cursor::CursorKind)> {
        ...
        if !options.is_ascending() {
            self.set_terminal_record(
                ...
                RangeExhaustion::CursorBound {
                    kind: haneul_rpc_cursor::CursorKind::Boundary,
                },
            );
        }
        ...
        let kind = if options.is_ascending() {
            ...
            haneul_rpc_cursor::CursorKind::Boundary
        };
...
impl ScanCursor<u64> for CursorToken {
    ...
    fn resume_lo(&self) -> Bound<u64> {
        ...
        match self.kind {
            haneul_rpc_cursor::CursorKind::Item => Bound::Included(position.saturating_add(1)),
    ...
    fn applies_canonical_cursor_bounds() {
        ...
        assert_eq!(
            ...
            empty_resolved_range(
                ...
                u64::MAX,
                RangeExhaustion::CursorBound {
                    kind: haneul_rpc_cursor::CursorKind::Item,
                },
            )
        );
