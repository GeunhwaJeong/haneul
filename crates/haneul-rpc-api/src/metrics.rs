...
use haneul_http::middleware::callback::{MakeCallbackHandler, ResponseHandler};
use prometheus::{
...
impl ListRequestMetrics {
    ...
    pub(crate) fn finish_success(
        &mut self,
        reason: haneul_rpc::proto::haneul::rpc::v2::QueryEndReason,
        ...
        let reason = match reason {
            haneul_rpc::proto::haneul::rpc::v2::QueryEndReason::ItemLimit => "item_limit",
            haneul_rpc::proto::haneul::rpc::v2::QueryEndReason::ScanLimit => "scan_limit",
            haneul_rpc::proto::haneul::rpc::v2::QueryEndReason::LedgerTip => "ledger_tip",
            haneul_rpc::proto::haneul::rpc::v2::QueryEndReason::CheckpointBound => {
                "checkpoint_bound"
            }
            haneul_rpc::proto::haneul::rpc::v2::QueryEndReason::CursorBound => "cursor_bound",
            // Validation guarantees successful List streams always have a concrete end reason.
            haneul_rpc::proto::haneul::rpc::v2::QueryEndReason::Unknown => {
...
mod tests {
    ...
    fn known_grpc_method_without_matched_path_uses_uri_path_label() {
        let mut allowlist = HashSet::new();
        allowlist.insert("/haneul.rpc.v2.LedgerService/ListTransactions".to_owned());
        ...
        assert_eq!(label, "/haneul.rpc.v2.LedgerService/ListTransactions");
    }
