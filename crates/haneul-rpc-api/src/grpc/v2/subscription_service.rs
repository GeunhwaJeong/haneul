...
use haneul_rpc::proto::haneul::rpc::v2::ObjectSet as ProtoObjectSet;
...
use haneul_rpc::proto::haneul::rpc::v2::SubscribeEventsRequest;
use haneul_rpc::proto::haneul::rpc::v2::SubscribeEventsResponse;
use haneul_rpc::proto::haneul::rpc::v2::SubscribeTransactionsRequest;
use haneul_rpc::proto::haneul::rpc::v2::SubscribeTransactionsResponse;
...
fn transaction_objects<'a>(
    transaction: &'a haneul_types::full_checkpoint_content::ExecutedTransaction,
    checkpoint_objects: &'a haneul_types::full_checkpoint_content::ObjectSet,
) -> impl Iterator<Item = &'a haneul_types::object::Object> + 'a {
...
fn render_transaction_message(
    ...
    if read_mask.contains(ExecutedTransaction::TIMESTAMP_FIELD) {
        message.timestamp = Some(haneul_rpc::proto::timestamp_ms_to_proto(
