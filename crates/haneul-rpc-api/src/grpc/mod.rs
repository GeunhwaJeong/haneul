...
use haneul_http::middleware::grpc_timeout::GrpcTimeout;
...
impl Services {
    ...
    pub fn into_router(
        self,
        request_log: haneullabs_network::request_log::GrpcRequestLogLayer,
    ) -> axum::Router {
...
mod tests {
    ...
    use haneullabs_network::request_log::GrpcRequestLogLayer;
    use prost::Message;
