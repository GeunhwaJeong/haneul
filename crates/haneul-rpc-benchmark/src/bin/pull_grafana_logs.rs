...
async fn run() -> Result<(), Box<dyn Error>> {
    let grafana_url = env::var("GRAFANA_LOGS_URL").unwrap_or_else(|_| {
        "https://metrics.haneulfoundation.org/loki/api/v1/query_range".to_string()
    });
