...
mod tests {
    ...
    fn legacy_lock_reports_branches_but_not_hashes() {
        let lock = r#"
            ...
            [[move.package]]
            id = "Haneul"
            source = { git = "https://github.com/GeunhwaJeong/haneul.git", rev = "framework/mainnet", subdir = "x" }

            [[move.package]]
            id = "MoveStdlib"
            source = { git = "https://github.com/GeunhwaJeong/haneul.git", rev = "041c5f2bae2fe52079e44b70514333532d69f4e6" }
        "#;

        assert_eq!(
            moving_revisions_in(lock),
            vec![MovingRevision {
                dependency: "Haneul".to_string(),
    ...
    fn pinned_lock_reports_nothing() {
        let lock = r#"
            ...
            source = { git = "https://github.com/GeunhwaJeong/deepbookv3.git", rev = "5e82e2dd1ea7d47957855ddc66f835585d6fe091" }
        "#;
    ...
    fn legacy_lock_uses_the_name_field() {
        let lock = r#"
            [[move.package]]
            name = "Haneul"
            source = { git = "https://github.com/GeunhwaJeong/haneul.git", rev = "framework/mainnet" }
        "#;
    ...
    fn truncated_hash_is_not_reported() {
        let lock = r#"
            [[move.package]]
            id = "Haneul"
            source = { git = "https://github.com/GeunhwaJeong/haneul.git", rev = "041c5f2bae" }
        "#;
