...
//# programmable --sender B --inputs allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(30,@A,object(3,0)) allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(30,@A,object(3,0)) allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(30,@A,object(3,0)) mutshared(3,0) immshared(6) @B
...
//> 4: haneul::allowance::balance_spend<haneul::haneul::HANEUL>(Input(3), Input(2), Input(4));
//> 5: haneul::balance::send_funds<haneul::haneul::HANEUL>(Result(4), Input(5));

//# view-object 3,0
// current_spend is 90: three spends of 30.

//# programmable --sender B --inputs allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(5,@A,object(3,0)) allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(10,@A,object(3,0)) mutshared(3,0) immshared(6) @B
...
//> 2: haneul::allowance::balance_spend<haneul::haneul::HANEUL>(Input(2), Input(1), Input(3));
...
//# programmable --sender B --inputs allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(60,@A,object(3,0)) allowance_withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(60,@A,object(3,0)) mutshared(3,0) immshared(6) @B
