...
//> 0: Agree_V0::m::ping();
//> 1: haneul::package::authorize_upgrade(Input(0), Input(1), Input(2));
//> 2: Upgrade(Agree_V1, [Dep_V1,Extra,haneul,std], Agree_V0, Result(1));
//> haneul::package::commit_upgrade(Input(0), Result(2))
...
//> 0: haneul::package::authorize_upgrade(Input(0), Input(1), Input(2));
//> 1: Upgrade(A1_Dep1, [Dep_V1,haneul,std], A0, Result(0));
//> 2: haneul::package::commit_upgrade(Input(0), Result(1));
//> 3: haneul::package::authorize_upgrade(Input(3), Input(4), Input(5));
//> 4: Upgrade(D1_Dep2, [Dep_V2,haneul,std], D0, Result(3));
//> haneul::package::commit_upgrade(Input(3), Result(4))
...
//> 2: haneul::package::commit_upgrade(Input(0), Result(1));
//> 3: haneul::package::authorize_upgrade(Input(3), Input(4), Input(5));
//> 4: Upgrade(D1_Dep1, [Dep_V1,haneul,std], D0, Result(3));
//> haneul::package::commit_upgrade(Input(3), Result(4))
...
//> 1: haneul::package::authorize_upgrade(Input(0), Input(1), Input(2));
//> 2: Upgrade(Refine_V1_Dep2, [Dep_V2,haneul,std], Refine_V0, Result(1));
//> haneul::package::commit_upgrade(Input(0), Result(2))
