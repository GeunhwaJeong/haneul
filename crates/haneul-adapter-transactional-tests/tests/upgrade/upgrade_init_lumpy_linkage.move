...
//> 1: Upgrade(NoInit_V1, [Dep_V1,haneul,std], NoInit_V0, Result(0));
//> 2: Dep_V2::d::ping();
...
//> 0: haneul::package::authorize_upgrade(Input(0), Input(1), Input(2));
//> 1: Upgrade(Init_V1_Dep1, [Dep_V1,haneul,std], Init_V0, Result(0));
//> 2: Dep_V2::d::ping();
//> haneul::package::commit_upgrade(Input(0), Result(1))
...
//> 2: Upgrade(Init_V1_Dep2, [Dep_V2,haneul,std], Init_V0, Result(1));
...
//> 0: haneul::package::authorize_upgrade(Input(0), Input(1), Input(2));
//> 1: Upgrade(Init_V1_Dep2, [Dep_V2,haneul,std], Init_V0, Result(0));
//> 2: Dep_V2::d::ping();
//> haneul::package::commit_upgrade(Input(0), Result(1))
