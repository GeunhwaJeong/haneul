...
//> 1: haneul::coin::send_funds<test::regulated_coin::REGULATED_COIN>(Result(0), Input(2));
...
//# programmable --sender C --inputs allowance_withdraw<haneul::balance::Balance<test::regulated_coin::REGULATED_COIN>>(100,@B,object(4,0)) mutshared(4,0) immshared(6) @C
// C spends while nobody is denied.
//> 0: haneul::allowance::balance_spend<test::regulated_coin::REGULATED_COIN>(Input(1), Input(0), Input(2));
//> 1: haneul::coin::from_balance<test::regulated_coin::REGULATED_COIN>(Result(0));
