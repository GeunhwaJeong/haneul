...
//> test::m::gen_mut_id<haneul::tx_context::TxContext>(Result(0));

//# programmable
// the same shape through immutable references
//> 0: test::m::tx_context_imm_id();
//> test::m::gen_imm_id<haneul::tx_context::TxContext>(Result(0));

//# programmable
// a generic identity's own result cannot be fed back into it either
//> 0: test::m::gen_mut_id<haneul::tx_context::TxContext>();
//> test::m::gen_mut_id<haneul::tx_context::TxContext>(Result(0));
