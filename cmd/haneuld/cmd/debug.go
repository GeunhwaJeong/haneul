...
// get cmd to convert any bech32 address to a haneul prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the haneul prefix",
...
Example:
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "haneul", "Bech32 Prefix to encode to")
