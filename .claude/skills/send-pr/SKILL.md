...
- Markdown files that are throwaway working notes — an implementation plan you wrote for yourself, a debugging scratchpad — as opposed to documentation intended for the repository. Documentation that is part of the change (a `DESIGN.md`, a README, a `docs/` page) should be committed like any other file.
- Log files
