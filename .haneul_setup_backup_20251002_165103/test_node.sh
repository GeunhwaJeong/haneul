...
from_scratch () {
  ...
  junod init $MONIKER --chain-id $CHAIN_ID --default-denom uhaneul
  ...
  junod genesis add-genesis-account $KEY 10000000uhaneul,1000utest --keyring-backend $KEYRING
  junod genesis add-genesis-account $KEY2 1000000uhaneul,1000utest --keyring-backend $KEYRING
  junod genesis add-genesis-account juno1see0htr47uapjvcvh0hu6385rp8lw3emu85lh5 100000000000uhaneul --keyring-backend $KEYRING

  junod genesis gentx $KEY 1000000uhaneul --keyring-backend $KEYRING --chain-id $CHAIN_ID
